...
class SocialFacade {
  ...
  static bool isUserOnline(UserProfile? user) => SocialHelpers.isUserOnline(user);

  static String? getUserAvatarUrl(UserProfile? user) => SocialHelpers.getUserAvatarUrl(user);

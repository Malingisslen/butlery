      ...
      builder: (context) => RetagProgressDialog(
        retagFunction: (onProgress) async {
          ...
          return await taggingService.retagUserRecipes(
            ...
            saveRecipe: (recipe) =>
                recipeService.personal.updateRecipe(recipe),
    ...
    try {
      ...
      if (context.mounted) {
        SnackBarUtils.showError(
            context, context.l10n.personalTagCouldNotShare);
      }
    }
  }
      ...
      builder: (dialogContext) {
        ...
        return StatefulBuilder(
          builder: (context, setState) => AlertDialog(
            ...
            content:
                Text(context.l10n.personalTagDeleteTagMessage(tag.name)),
            actions: [
              TextButton(
                onPressed:
                    isLoading ? null : () => Navigator.pop(dialogContext),
                        ...
                        try {
                          ...
                          if (success) {
                            SnackBarUtils.showSuccess(
                              context,
                              context.l10n
                                  .personalTagGroupCreatedAndTagMoved,
                            );
                          }
                        } catch (e) {
                          if (!dialogContext.mounted) return;

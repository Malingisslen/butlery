/// Comprehensive unified recipe data model providing multi-type recipe management with modular architecture.
///
/// This model system implements sophisticated recipe data management following Single Responsibility Principle,
/// orchestrating specialized modules for different aspects of recipe handling including core data management,
/// social collaboration, real-time editing, and offline capabilities. It provides comprehensive recipe
/// functionality through clean modular architecture with focused single-responsibility components.
///
/// **Single Responsibility Focus:**
/// This model system exclusively handles recipe data management and operations:
/// - **Core Recipe Data**: Fundamental recipe information with immutable ID and mutable content fields
/// - **Multi-Type Support**: Personal, shared, collaborative, and real-time recipe types with specialized behaviors
/// - **Social Integration**: Comprehensive social metadata with member permissions and collaborative features
/// - **Real-time Capabilities**: Live collaborative editing with presence tracking and conflict resolution
///
...
/// - Storage and persistence (handled by repositories and services)
///
/// **Modular Architecture:**
/// - **RecipeCore**: Core recipe data with serialization and basic operations
/// - **RecipeSocialData**: Social metadata including ownership, permissions, and collaboration settings
/// - **RecipeRealtimeData**: Real-time collaboration metadata with editing tracking and presence information
/// - **RecipeOperations**: Content manipulation operations with user tracking and change management
/// - **RecipeFactory**: Construction and conversion methods for different recipe types
/// - **RecipeSerialization**: JSON and Firestore serialization with data validation
///
/// **Recipe Model Features:**
/// - **Multi-Type System**: Support for personal, shared, collaborative, and real-time recipe types
/// - **Social Collaboration**: Comprehensive member management with granular permissions and sharing controls
/// - **Real-time Editing**: Live collaborative editing with presence tracking and conflict resolution
/// - **Offline Support**: Offline capability with sync tracking and local storage optimization
/// - **Comprehensive Metadata**: Complete recipe metadata including ratings, tags, cooking history, and analytics
///
/// **Usage Examples:**
/// ```dart
...
///   description: 'Traditionellt recept från mormor',
///   ingredients: ['500g köttfärs', '1 ägg', '2 dl ströbröd'],
///   instructions: ['Blanda allt', 'Forma bollar', 'Stek i smör'],
///   mealType: 'Middag',
///   portions: 4,
///   timeMinutes: 45,
/// );
/// 
/// // Collaborative recipe with members
/// final collaborativeRecipe = Recipe.collaborative(
///   title: 'Familjerecept - Pizza',
///   description: 'Vår gemensamma pizzarecept',
///   ingredients: ['500g mjöl', '300ml vatten', 'jäst'],
///   instructions: ['Blanda deg', 'Jäs 1h', 'Kavla ut', 'Toppa och grädda'],
///   mealType: 'Middag',
///   ownerId: currentUserId,
///   ownerDisplayName: 'Anna',
///   memberPermissions: {memberId: ResourcePermission.edit},
/// );
/// 
/// // Recipe operations with user tracking

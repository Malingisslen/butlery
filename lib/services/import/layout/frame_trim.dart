...
/// tail trim's input and silently un-measured it. **Malin's call on
/// 2026-08-12**, made with the cheaper swap on the table and its cost stated.
/// Recorded in `docs/architecture/ACCEPTED_DEVIATIONS.md` under the BUT-1816
/// trim entry, which is the tracked record — the plan snapshot itself lives
/// under `tasks/`, which is gitignored, so do not cite that path as evidence.
/// (The crossing guard below is an ENGINEERING call, labelled differently on
/// purpose.)
///

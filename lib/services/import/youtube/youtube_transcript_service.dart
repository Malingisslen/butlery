...
class YouTubeTranscriptService {
  ...
  Future<TranscriptResult> fetchTranscript(String videoIdOrUrl) async {
    ...
    try {
      ...
      if (captionTracks.isEmpty) {
        return TranscriptResult.failure('No captions available for this video');
      }
      ...
      return TranscriptResult.failure('Error fetching transcript: $e');
    }
  }
  ...
  List<CaptionTrack> _parseCaptionTracksFromPlayerResponse(
    ...
    try {
      ...
      }).where((track) => track.baseUrl.isNotEmpty).toList();
    } catch (e) {
      return [];
    }
  }

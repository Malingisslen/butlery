// lib/services/social_media_extractor_mobile.dart
...
// Conditional import baserat på platform
import 'package:flutter_inappwebview/flutter_inappwebview.dart'
    if (dart.library.html) 'inappwebview_stub.dart';
...
class SocialMediaExtractor implements SocialMediaExtractorInterface {
  ...
  Future<ExtractionResult> extractFromUrl(String url) async {
    // På webben, returnera alltid fel
    if (kIsWeb) {
      return ExtractionResult(
        success: false,
        error: 'Social media extraction är inte tillgänglig på webben',
      );
    }

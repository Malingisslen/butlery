...
class ImageMemoryCacheManager {
  static final ImageMemoryCacheManager _instance = ImageMemoryCacheManager._internal();
  ...
  void checkMemoryPressure() {
    ...
    if (currentSizeMB > _maxCacheSizeMB) {
      AppLogger.warning('Image cache memory pressure: ${currentSizeMB.toStringAsFixed(2)}MB');

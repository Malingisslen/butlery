...
class SocialRecipeService extends ChangeNotifier
  ...
  Future<void> _loadSharedContent() async {
    ...
    try {
      _sharedRecipes = await _sharedRecipeRepository.getSharedRecipesForUser(currentUserId);
      _sharedMenus = await _sharedMenuRepository.getSharedMenusForUser(currentUserId);
    } catch (e) {

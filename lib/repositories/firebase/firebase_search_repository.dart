...
class FirestoreSearchRepository implements SearchRepository {
  ...
  Future<SearchResult<RecipeSearchHit>> searchRecipes(
    ...
    try {
      ...
      var queryRef = _firestore.collection(FirestoreCollections.sharedRecipesDenorm).limit(hitsPerPage);
  ...
  Future<bool> healthCheck() async {
    try {
      await _firestore.collection(FirestoreCollections.sharedRecipesDenorm).limit(1).get();
      return true;
    } catch (e) {
      return false;
    }

...
class FirebaseMenuCollaborationRepository
  ...
  Future<String?> createMenuTemplate({
    ...
    try {
      ...
      final docRef =
          await firestore.collection(FirestoreCollections.menuTemplates).add(templateData);
  ...
  Future<bool> deleteMenuTemplate(String templateId) async {
    try {
      ...
      final doc =
          await firestore.collection(FirestoreCollections.menuTemplates).doc(templateId).get();
      ...
      await firestore.collection(FirestoreCollections.menuTemplates).doc(templateId).delete();

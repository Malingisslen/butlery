...
class CreateGroupViewModel extends ChangeNotifier {
  ...
  /// Group creation operation state for UI progress indication during creation workflow.
  /// 
  /// Indicates active group creation for loading indicators and interaction
  /// control during group creation and invitation sending processes.
  ...
  /// throughout group creation operations and workflow management.
  String? _error;
  ...
  /// Group creation operation state for UI progress indication and interaction control.
  /// 
  /// Indicates whether group creation is in progress for loading indicators
  /// and user interaction management during creation workflow operations.
  bool get isCreating => _isCreating;
  
  /// Error message for user feedback and comprehensive error state management.
  /// 
  /// Provides access to current error state enabling error display
  /// and recovery coordination throughout group creation operations.

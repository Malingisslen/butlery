...
class DiscoveryDashboardViewModel extends ChangeNotifier with StreamManagementMixin {
  ...
  DiscoveryDashboardViewModel() {
    ...
    _contentManager = DiscoveryContentManager(discoveryService: _discoveryService);
    _friendActivityManager = DiscoveryFriendActivityManager(discoveryService: _discoveryService);
    _recommendationsManager = DiscoveryRecommendationsManager(recommendationService: _recommendationService);
  ...
  List<Map<String, dynamic>> get friendActivity => _friendActivityManager.friendActivity;
  ...
  Map<String, dynamic> get discoveryStats => {
    ...
    'recommendations': _recommendationsManager.personalizedRecommendations.length,
  ...
  void _applyCategoryFilter() {
    ...
    AppLogger.info('🔧 Applied category filter: $_selectedCategory via content manager');
    notifyListeners();
  }

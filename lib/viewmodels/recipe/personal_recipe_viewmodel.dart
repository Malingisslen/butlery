...
class PersonalRecipeViewModel extends ChangeNotifier
  ...
  Future<bool> addIngredient(String recipeId, String ingredient) async {
    ...
    final result = await _recipeService.personal.addIngredient(
      recipeId,
      ingredient,
    );
    if (result) {
  ...
  Future<bool> updateIngredient(
    ...
    final result = await _recipeService.personal.updateIngredient(
      recipeId,
      index,
      newIngredient,
    );
  ...
  Future<bool> removeIngredient(String recipeId, int index) async {
    ...
    final result = await _recipeService.personal.removeIngredient(
      recipeId,
      index,
    );
    if (result) {
  ...
  Future<bool> updateInstruction(
    ...
    return await _recipeService.personal.updateInstruction(
      recipeId,
      index,
      newInstruction,
    );
  ...
  Future<RecipeOperationResult> addLegacyRecipe(Recipe recipe) async {
    ...
    return await safeExecute(
          () async {
            final result = await _recipeService.personal.addLegacyRecipe(
              recipe,
            );
            if (result.isSuccess) {
              AppLogger.success(
  ...
  Future<RecipeOperationResult> updateLegacyRecipe(Recipe recipe) async {
    ...
    return await safeExecute(
          () async {
            final result = await _recipeService.personal.updateLegacyRecipe(
              recipe,
            );
            if (result.isSuccess) {
              AppLogger.info(
          ...
          defaultValue: RecipeOperationResult.failure(

...
/// Configuration class for Firebase API keys and settings
/// 
/// This class reads Firebase configuration from environment variables
/// to avoid hardcoding sensitive API keys in the codebase.
/// 
/// Usage:
/// ```dart
/// FirebaseOptions(

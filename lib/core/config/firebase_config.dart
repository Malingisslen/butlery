...
class FirebaseConfig {
  ...
  static final Map<String, String> _envMap = {
    'FIREBASE_API_KEY_WEB': const String.fromEnvironment('FIREBASE_API_KEY_WEB'),
    'FIREBASE_API_KEY_ANDROID': const String.fromEnvironment('FIREBASE_API_KEY_ANDROID'),
    'FIREBASE_API_KEY_IOS': const String.fromEnvironment('FIREBASE_API_KEY_IOS'),
    'FIREBASE_API_KEY_MACOS': const String.fromEnvironment('FIREBASE_API_KEY_MACOS'),
    'FIREBASE_API_KEY_WINDOWS': const String.fromEnvironment('FIREBASE_API_KEY_WINDOWS'),
    'FIREBASE_APP_ID_WEB': const String.fromEnvironment('FIREBASE_APP_ID_WEB'),
    'FIREBASE_APP_ID_ANDROID': const String.fromEnvironment('FIREBASE_APP_ID_ANDROID'),
    'FIREBASE_APP_ID_IOS': const String.fromEnvironment('FIREBASE_APP_ID_IOS'),
    'FIREBASE_APP_ID_MACOS': const String.fromEnvironment('FIREBASE_APP_ID_MACOS'),
    'FIREBASE_APP_ID_WINDOWS': const String.fromEnvironment('FIREBASE_APP_ID_WINDOWS'),
    'FIREBASE_MESSAGING_SENDER_ID': const String.fromEnvironment('FIREBASE_MESSAGING_SENDER_ID'),
    'FIREBASE_PROJECT_ID': const String.fromEnvironment('FIREBASE_PROJECT_ID'),
    'FIREBASE_AUTH_DOMAIN': const String.fromEnvironment('FIREBASE_AUTH_DOMAIN'),
    'FIREBASE_STORAGE_BUCKET': const String.fromEnvironment('FIREBASE_STORAGE_BUCKET'),

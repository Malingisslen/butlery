...
class FirebaseConfig {
  ...
  static String get apiKeyMacOS =>
      ...
      _throwMissingKey('FIREBASE_API_KEY_MACOS');

  static String get apiKeyWindows =>
      dotenv.env['FIREBASE_API_KEY_WINDOWS'] ??
      _throwMissingKey('FIREBASE_API_KEY_WINDOWS');
  ...
  static String get appIdMacOS =>
      ...
      _throwMissingKey('FIREBASE_APP_ID_MACOS');

  static String get appIdWindows =>
      dotenv.env['FIREBASE_APP_ID_WINDOWS'] ??
      _throwMissingKey('FIREBASE_APP_ID_WINDOWS');

...
class $OfflineRecipesTable extends OfflineRecipes
  ...
  VerificationContext validateIntegrity(
    Insertable<OfflineRecipe> instance, {
...
class OfflineRecipe extends DataClass implements Insertable<OfflineRecipe> {
  ...
  factory OfflineRecipe.fromJson(
...
class $JsonCacheEntriesTable extends JsonCacheEntries
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<JsonCacheEntry> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class JsonCacheEntry extends DataClass implements Insertable<JsonCacheEntry> {
  ...
  factory JsonCacheEntry.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class $ParseCacheEntriesTable extends ParseCacheEntries
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ParseCacheEntry> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class ParseCacheEntry extends DataClass implements Insertable<ParseCacheEntry> {
  ...
  factory ParseCacheEntry.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $JsonCacheEntriesTable jsonCacheEntries = $JsonCacheEntriesTable(
    this,
  );
...
typedef $$OfflineRecipesTableCreateCompanionBuilder =
    OfflineRecipesCompanion Function({
      required String id,
      required String userId,
      required String recipeJson,
      required DateTime updatedAt,
...
typedef $$OfflineRecipesTableUpdateCompanionBuilder =
    OfflineRecipesCompanion Function({
      Value<String> id,
      Value<String> userId,
      Value<String> recipeJson,
...
class $$OfflineRecipesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $OfflineRecipesTable,
...
typedef $$OfflineRecipesTableProcessedTableManager =
...
class $$JsonCacheEntriesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$JsonCacheEntriesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $JsonCacheEntriesTable,
      JsonCacheEntry,
...
class $$ParseCacheEntriesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$ParseCacheEntriesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ParseCacheEntriesTable,
      ParseCacheEntry,

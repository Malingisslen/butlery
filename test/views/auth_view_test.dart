...
void main() {
  group('AuthView Integration Tests', () {
    ...
    group('Provider Setup Tests', () {
      testWidgets('should initialize AuthViewModel provider correctly', (tester) async {
        // Arrange: Setup authentication provider
        final providers = ProviderTestUtils.setupAuthProviders(isAuthenticated: false);
      ...
      testWidgets('should render authentication form with Swedish localization', (tester) async {
        // Arrange
        ...
        ViewTestHelpers.expectSwedishText(tester, 'Logga in'); // Login mode header
        ViewTestHelpers.expectSwedishText(tester, 'E-post'); // Email field label
        ViewTestHelpers.expectSwedishText(tester, 'Lösenord'); // Password field label
        ViewTestHelpers.expectSwedishText(tester, 'Glömt lösenord?'); // Forgot password link
        ViewTestHelpers.expectSwedishText(tester, 'Har du inget konto? Skapa konto'); // Mode toggle
      });
    });
    ...
    group('Form Mode Switching Tests', () {
      testWidgets('should switch from login to registration mode correctly', (tester) async {
        ...
        expect(find.text('Ditt namn'), findsNothing); // Name field not visible in login
        ...
        ViewTestHelpers.expectSwedishText(tester, 'Ditt namn'); // Name field now visible
        ViewTestHelpers.expectSwedishText(tester, 'Har du redan ett konto? Logga in'); // Toggle text changed
        expect(find.text('Glömt lösenord?'), findsNothing); // Forgot password hidden in registration
      });
      
      testWidgets('should switch back from registration to login mode', (tester) async {
    ...
    group('Form Field Rendering Tests', () {
      testWidgets('should render email field with correct configuration', (tester) async {
        // Arrange
        final providers = ProviderTestUtils.setupAuthProviders();
      ...
      testWidgets('should render password field with visibility toggle', (tester) async {
        // Arrange
        final testableViewModel = TestableViewModelFactory.createAuthViewModel();
        final providers = [
          ChangeNotifierProvider<AuthViewModel>.value(value: testableViewModel),
      ...
      testWidgets('should render name field only in registration mode', (tester) async {
        ...
        ViewTestHelpers.expectSwedishText(tester, 'Ange ditt namn'); // Hint text
    ...
    group('Form Validation Tests', () {
      testWidgets('should validate email field with Swedish error messages', (tester) async {
        // Arrange
        final providers = ProviderTestUtils.setupAuthProviders();
      ...
      testWidgets('should validate password field with strength requirements', (tester) async {
    ...
    group('Login Flow Tests', () {
      testWidgets('should perform complete login workflow with Swedish input', (tester) async {
      ...
      testWidgets('should handle login success scenario', (tester) async {
        ...
        expect(stateTransitions, contains(contains('auth_state_authenticated')));
      });
      
      testWidgets('should handle login error with Swedish error messages', (tester) async {
    ...
    group('Registration Flow Tests', () {
      testWidgets('should perform complete registration workflow', (tester) async {
      ...
      testWidgets('should handle registration success scenario', (tester) async {
      ...
      testWidgets('should handle registration errors with Swedish messaging', (tester) async {
        // Arrange
        final testableViewModel = TestableViewModelFactory.createAuthViewModel();
        final providers = [
          ChangeNotifierProvider<AuthViewModel>.value(value: testableViewModel),
    ...
    group('Password Visibility Tests', () {
      testWidgets('should toggle password visibility correctly', (tester) async {
        // Arrange
        final testableViewModel = TestableViewModelFactory.createAuthViewModel();
        final providers = [
          ChangeNotifierProvider<AuthViewModel>.value(value: testableViewModel),
    ...
    group('Password Reset Dialog Tests', () {
      testWidgets('should show password reset dialog with Swedish localization', (tester) async {
        // Arrange
        final providers = ProviderTestUtils.setupAuthProviders();
      ...
      testWidgets('should handle password reset dialog cancellation', (tester) async {
        // Arrange
        final providers = ProviderTestUtils.setupAuthProviders();
      ...
      testWidgets('should handle password reset email submission', (tester) async {
        // Arrange
        final testableViewModel = TestableViewModelFactory.createAuthViewModel();
        final providers = [
          ChangeNotifierProvider<AuthViewModel>.value(value: testableViewModel),
        ...
        expect(find.text('reset@exempel.se'), findsNothing); // Email should be cleared from dialog
      });
    });
    
    group('Error Injection & Recovery Tests', () {
      testWidgets('should handle injected login errors correctly', (tester) async {
        ...
        testableViewModel.injectError('Inloggningen misslyckades på grund av nätverksfel');
        ...
        expect(find.text('Inloggningen misslyckades på grund av nätverksfel'), findsOneWidget);
      ...
      testWidgets('should handle registration error injection', (tester) async {
        ...
        testableViewModel.injectError('Kontot kunde inte skapas: E-postadressen är redan registrerad');
        ...
        expect(find.text('Kontot kunde inte skapas: E-postadressen är redan registrerad'), findsOneWidget);
      });
      
      testWidgets('should recover from error state when retrying', (tester) async {
    ...
    group('Resource Management & Lifecycle Tests', () {
      testWidgets('should properly dispose resources when widget is removed', (tester) async {
        // Arrange
        final providers = ProviderTestUtils.setupAuthProviders();
    ...
    group('Edge Cases & Boundary Testing', () {
      testWidgets('should handle rapid mode switching without errors', (tester) async {
        // Arrange
        final providers = ProviderTestUtils.setupAuthProviders();
      ...
      testWidgets('should handle form submission with empty fields', (tester) async {
        // Arrange
        final providers = ProviderTestUtils.setupAuthProviders();
      ...
      testWidgets('should handle Swedish character input edge cases', (tester) async {
        // Arrange
        final providers = ProviderTestUtils.setupAuthProviders();

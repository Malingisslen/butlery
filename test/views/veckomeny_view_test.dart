...
void main() {
  group('VeckomenyView Tests - ULTRATHINK METHODOLOGY', () {
    ...
    setUp(() async {
      ...
      TestServiceLocator.registerFactory<MenuViewModel>(
          () => TestServiceLocator.get<MenuViewModel>());
      TestServiceLocator.registerFactory<ShareService>(
          () => TestServiceLocator.get<ShareService>());
      TestServiceLocator.registerFactory<UnifiedFriendsService>(
          () => TestServiceLocator.get<UnifiedFriendsService>());
      TestServiceLocator.registerFactory<UniversalShareDialogViewModel>(
          () => TestServiceLocator.get<UniversalShareDialogViewModel>());
    });
    ...
    group('Provider Integration Tests', () {
      testWidgets('should initialize with ChangeNotifierProvider architecture',
        ...
        expect(
            find.byType(ChangeNotifierProvider<MenuViewModel>), findsOneWidget);
        expect(find.byType(VeckomenyView), findsOneWidget);
      });

      testWidgets('should initialize MenuViewModel via ServiceLocator',
          (WidgetTester tester) async {
      ...
      testWidgets('should delegate to StatefulWidget content properly',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle optional SharedMenu parameter',
          (WidgetTester tester) async {
    ...
    group('StatefulWidget Lifecycle Tests', () {
      testWidgets('should initialize StatefulWidget with TextEditingController',
          (WidgetTester tester) async {
      ...
      testWidgets('should setup TextEditingController listener in initState',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle prompt input changes via listener',
          (WidgetTester tester) async {
    ...
    group('Service Integration Tests', () {
      testWidgets('should integrate with ShareService',
          (WidgetTester tester) async {
      ...
      testWidgets('should integrate with UnifiedFriendsService',
          (WidgetTester tester) async {
      ...
      testWidgets('should integrate with UniversalShareDialogViewModel',
          (WidgetTester tester) async {
    ...
    group('UI Structure Tests', () {
      testWidgets('should render LayoutComponents.mainMenu structure',
          (WidgetTester tester) async {
      ...
      testWidgets('should display Swedish app title',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle PopScope with exit confirmation',
          (WidgetTester tester) async {
      ...
      testWidgets('should display Stack with content and overlay coordination',
          (WidgetTester tester) async {
      ...
      testWidgets('should show prompt input section properly',
          (WidgetTester tester) async {
    ...
    group('AI Menu Generation Tests', () {
      testWidgets('should display generation button with proper state',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle menu generation workflow',
          (WidgetTester tester) async {
      ...
      testWidgets('should show Swedish prompt hint text',
          (WidgetTester tester) async {
        ...
        expect(find.text('Ex: 3 middagar, 2 luncher och 1 frukost'),
            findsOneWidget);
      });

      testWidgets('should handle prompt input validation',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle prompt submission on Enter key',
          (WidgetTester tester) async {
    ...
    group('Menu Operations Tests', () {
      testWidgets('should handle menu clearing operation',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle section regeneration',
          (WidgetTester tester) async {
      ...
      testWidgets('should show menu summary when menu exists',
          (WidgetTester tester) async {
      ...
      testWidgets('should display empty state when no menu',
          (WidgetTester tester) async {
    ...
    group('Action Bar Tests', () {
      testWidgets('should show load menu button in action bar',
          (WidgetTester tester) async {
      ...
      testWidgets('should conditionally show save menu button',
          (WidgetTester tester) async {
      ...
      testWidgets('should conditionally show social share button',
          (WidgetTester tester) async {
      ...
      testWidgets('should conditionally show external share button',
          (WidgetTester tester) async {
      ...
      testWidgets('should conditionally show clear menu button',
          (WidgetTester tester) async {
      ...
      testWidgets('should show error indicator when hasError',
          (WidgetTester tester) async {
    ...
    group('Loading States Tests', () {
      testWidgets('should display loading overlay during generation',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle loading overlay styling properly',
          (WidgetTester tester) async {
    ...
    group('Floating Action Button Tests', () {
      testWidgets('should show floating action button when menu exists',
          (WidgetTester tester) async {
      ...
      testWidgets('should display Swedish shopping button text',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle shopping list selector trigger',
          (WidgetTester tester) async {
      ...
      testWidgets('should hide FloatingActionButton when no menu',
          (WidgetTester tester) async {
    ...
    group('Dialog Operations Tests', () {
      testWidgets('should handle save menu dialog presentation',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle load menu dialog presentation',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle social share dialog presentation',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle exit confirmation dialog',
          (WidgetTester tester) async {
      ...
      testWidgets('should show Swedish dialog text',
          (WidgetTester tester) async {
    ...
    group('Navigation Tests', () {
      testWidgets('should handle recipe detail navigation',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle SystemNavigator.pop on exit',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle context.mounted checks in navigation',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle Navigator.pop in dialog operations',
          (WidgetTester tester) async {
    ...
    group('Error Handling Tests', () {
      testWidgets('should handle menu validation errors',
          (WidgetTester tester) async {
      ...
      testWidgets('should show Swedish warning messages',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle service integration errors',
          (WidgetTester tester) async {
    ...
    group('Swedish Localization Tests', () {
      testWidgets('should display Swedish UI labels',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle Swedish error messages',
          (WidgetTester tester) async {
...
class TestUniversalShareDialogViewModel

...
void main() {
  ...
  group('Share recipe journey', () {
    testWidgets(
      ...
      when(() => mockCoordinator.getSharedRecipesForUser(friendId))
      ...
      when(() => mockCoordinator.shareRecipeWithFriends(
        ...
        final friendIds = invocation.namedArguments[#friendIds] as List<String>;
      ...
      final inboxBefore =
          await mockCoordinator.getSharedRecipesForUser(friendId);
      expect(inboxBefore, isEmpty,
      ...
      verify(() => mockCoordinator.shareRecipeWithFriends(
            recipeId: recipe.id,
            friendIds: [friendId],
            message: null,
    ...
    testWidgets(
      ...
      verifyNever(() => mockCoordinator.shareRecipeWithFriends(
            recipeId: any(named: 'recipeId'),
            friendIds: any(named: 'friendIds'),
            message: any(named: 'message'),
            allowCollaboration: any(named: 'allowCollaboration'),

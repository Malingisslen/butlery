...
void main() {
  group('ImportViaUrlView Tests - ULTRATHINK METHODOLOGY', () {
    ...
    setUp(() async {
      ...
      TestServiceLocator.registerFactory<UrlImportViewModel>(
          () => TestServiceLocator.get<UrlImportViewModel>());
    });
    ...
    group('Provider Integration Tests', () {
      testWidgets('should initialize with ChangeNotifierProvider architecture',
        ...
        expect(find.byType(ChangeNotifierProvider<UrlImportViewModel>),
            findsOneWidget);
        expect(find.byType(ImportViaUrlView), findsOneWidget);
      });

      testWidgets('should initialize UrlImportViewModel via ServiceLocator',
          (WidgetTester tester) async {
      ...
      testWidgets('should provide UrlImportViewModel to content widget',
          (WidgetTester tester) async {
    ...
    group('StatefulWidget Lifecycle Tests', () {
      ...
      testWidgets('should handle URL input changes via listener',
          (WidgetTester tester) async {
    ...
    group('State Coordination Tests', () {
      testWidgets('should handle initial state display',
          (WidgetTester tester) async {
      ...
      testWidgets('should coordinate canFetch and isLoading states',
          (WidgetTester tester) async {
      ...
      testWidgets('should show loading state during URL fetch',
          (WidgetTester tester) async {
      ...
      testWidgets('should disable TextFormField during loading',
          (WidgetTester tester) async {
    ...
    group('URL Operations Tests', () {
      testWidgets('should handle URL input with proper validation',
          (WidgetTester tester) async {
      ...
      testWidgets('should trigger fetch on field submission',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle fetch operation via button',
          (WidgetTester tester) async {
      ...
      testWidgets('should coordinate fetch with ViewModel operations',
          (WidgetTester tester) async {
    ...
    group('Loading States Tests', () {
      testWidgets('should display CircularProgressIndicator during loading',
          (WidgetTester tester) async {
      ...
      testWidgets('should style loading indicator with proper colors',
          (WidgetTester tester) async {
      ...
      testWidgets('should coordinate button state with loading',
          (WidgetTester tester) async {
      ...
      testWidgets('should show proper loading dimensions',
          (WidgetTester tester) async {
    ...
    group('Error Handling Tests', () {
      ...
      testWidgets('should display error with proper spacing',
          (WidgetTester tester) async {
    ...
    group('Extracted Text Display Tests', () {
      testWidgets('should display extracted text when hasExtractedText is true',
          (WidgetTester tester) async {
      ...
      testWidgets('should show extracted text header with Swedish label',
          (WidgetTester tester) async {
      ...
      testWidgets('should use TextDisplayContainer for text preview',
          (WidgetTester tester) async {
      ...
      testWidgets('should show continue button after text extraction',
          (WidgetTester tester) async {
    ...
    group('Navigation Tests', () {
      testWidgets('should navigate to text import with extracted text',
          (WidgetTester tester) async {
      ...
      testWidgets('should pass text and sourceUrl as arguments',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle navigation only when hasExtractedText',
          (WidgetTester tester) async {
    ...
    group('Swedish Localization Tests', () {
      ...
      testWidgets('should use Swedish field labels and hints',
          (WidgetTester tester) async {
      ...
      testWidgets('should display Swedish button text',
          (WidgetTester tester) async {
    ...
    group('Theme Integration Tests', () {
      testWidgets('should use ComponentThemes for button styling',
          (WidgetTester tester) async {
      ...
      testWidgets('should integrate with app theme properly',
          (WidgetTester tester) async {
    ...
    group('UI Structure Tests', () {
      ...
      testWidgets('should display TextFormField with proper configuration',
          (WidgetTester tester) async {

...
void main() {
  group('PhotoImportView Tests - ULTRATHINK METHODOLOGY', () {
    ...
    group('Provider Integration Tests', () {
      testWidgets('should initialize with ChangeNotifierProvider architecture',
        ...
        expect(tester.takeException(), isNull,
            reason: 'No exceptions should occur during provider creation');

        // Verify ChangeNotifierProvider structure exists - look for the specific generic type
        expect(find.byType(ChangeNotifierProvider<PhotoImportViewModel>),
            findsOneWidget);
        expect(find.byType(PhotoImportView), findsOneWidget);
      });

      testWidgets('should initialize PhotoImportViewModel via ServiceLocator',
          (WidgetTester tester) async {
      ...
      testWidgets('should provide PhotoImportViewModel to content widget',
          (WidgetTester tester) async {
      ...
      testWidgets('should setup reactive updates with context.watch',
          (WidgetTester tester) async {
    ...
    group('StatelessWidget Architecture Tests', () {
      testWidgets('should initialize StatelessWidget wrapper architecture',
          (WidgetTester tester) async {
      ...
      testWidgets('should delegate to _PhotoImportViewContent',
          (WidgetTester tester) async {
      ...
      testWidgets('should maintain stateless architecture throughout lifecycle',
          (WidgetTester tester) async {
    ...
    group('Image Source Selection Tests', () {
      testWidgets('should show image source dialog on button press',
          (WidgetTester tester) async {
      ...
      testWidgets('should display camera option with Swedish text',
          (WidgetTester tester) async {
        ...
        expect(
            find.text('Använd kameran för att fota receptet'), findsOneWidget);
        expect(find.byIcon(Icons.camera_alt), findsOneWidget);
      });

      testWidgets('should display gallery option with Swedish text',
          (WidgetTester tester) async {
        ...
        expect(
            find.text('Välj en befintlig bild från telefonen'), findsOneWidget);
        expect(find.byIcon(Icons.photo_library), findsOneWidget);
      });

      testWidgets('should handle camera selection with ViewModel integration',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle gallery selection with ViewModel integration',
          (WidgetTester tester) async {
    ...
    group('Image Processing States Tests', () {
      testWidgets('should display initial empty state',
          (WidgetTester tester) async {
        ...
        expect(
            find.text('Tryck på knappen ovan för att välja'), findsOneWidget);
        expect(find.byIcon(Icons.add_photo_alternate),
            findsNWidgets(2)); // Button + empty state
      });

      testWidgets('should display processing state during OCR',
          (WidgetTester tester) async {
      ...
      testWidgets('should display loaded image with overlay controls',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle image removal with clearAll integration',
          (WidgetTester tester) async {
    ...
    group('OCR Processing Tests', () {
      testWidgets('should display OCR results when available',
          (WidgetTester tester) async {
      ...
      testWidgets('should show Swedish OCR results header',
          (WidgetTester tester) async {
      ...
      testWidgets('should use TextDisplayCard for OCR text preview',
          (WidgetTester tester) async {
      ...
      testWidgets('should show continue button after OCR completion',
          (WidgetTester tester) async {
    ...
    group('Navigation Tests', () {
      testWidgets('should navigate to text import with OCR results',
          (WidgetTester tester) async {
      ...
      testWidgets('should pass OCR text as navigation argument',
          (WidgetTester tester) async {
      ...
      testWidgets('should navigate to correct route',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle navigation only when hasOcrResult',
          (WidgetTester tester) async {
    ...
    group('Swedish Localization Tests', () {
      ...
      testWidgets('should display Swedish instructional content',
          (WidgetTester tester) async {
      ...
      testWidgets('should use Swedish button labels',
          (WidgetTester tester) async {
    ...
    group('Error Handling Tests', () {
      testWidgets('should display error state when hasError is true',
          (WidgetTester tester) async {
      ...
      testWidgets('should use StateWidget.error for error display',
          (WidgetTester tester) async {
      ...
      testWidgets('should show error message from ViewModel',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle error recovery with clearError action',
          (WidgetTester tester) async {
    ...
    group('Theme Integration Tests', () {
      testWidgets('should use UtilityComponents for button styling',
          (WidgetTester tester) async {
      ...
      testWidgets('should use AppDimensions for spacing',
          (WidgetTester tester) async {
      ...
      testWidgets('should use AppColors for styling',
          (WidgetTester tester) async {
      ...
      testWidgets('should use AppTextStyles for text styling',
          (WidgetTester tester) async {
    ...
    group('UI Structure Tests', () {
      testWidgets('should render main UI structure properly',
        ...
        expect(find.byType(Column),
            findsWidgets); // Multiple column widgets expected (main + nested)
      });

      testWidgets('should display informational container with proper styling',
          (WidgetTester tester) async {
      ...
      testWidgets('should show SizedBox spacing elements',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle conditional widget display',
          (WidgetTester tester) async {
    ...
    group('State Coordination Tests', () {
      testWidgets('should coordinate button state with processing',
          (WidgetTester tester) async {
      ...
      testWidgets('should update button text based on image state',
          (WidgetTester tester) async {
      ...
      testWidgets('should manage loading states during processing',
          (WidgetTester tester) async {
      ...
      testWidgets('should coordinate multiple state conditions',
          (WidgetTester tester) async {
    ...
    group('Performance and Integration Tests', () {
      ...
      testWidgets('should handle modal dialog interactions efficiently',
          (WidgetTester tester) async {

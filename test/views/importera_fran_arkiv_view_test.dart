...
void main() {
  group('ImporteraFranArkivView Tests - ULTRATHINK METHODOLOGY', () {
    ...
    setUp(() async {
      ...
      TestServiceLocator.registerFactory<ArchiveImportViewModel>(
          () => TestServiceLocator.get<ArchiveImportViewModel>());
    });
    ...
    group('Provider Integration Tests', () {
      testWidgets('should initialize with ChangeNotifierProvider architecture',
        ...
        expect(find.byType(ChangeNotifierProvider<ArchiveImportViewModel>),
            findsOneWidget);
        expect(find.byType(ImporteraFranArkivView), findsOneWidget);
      });

      testWidgets('should initialize ArchiveImportViewModel via ServiceLocator',
          (WidgetTester tester) async {
      ...
      testWidgets('should delegate to content widget properly',
          (WidgetTester tester) async {
    ...
    group('UI Structure Tests', () {
      ...
      testWidgets(
          'should build scrollable filter section with proper constraints',
          (WidgetTester tester) async {
      ...
      testWidgets('should show divider between filter and content',
          (WidgetTester tester) async {
      ...
      testWidgets('should build bottom action bar properly',
          (WidgetTester tester) async {
    ...
    group('Search and Filter System Tests', () {
      testWidgets('should display SearchFilterWidget.searchOnly',
          (WidgetTester tester) async {
      ...
      testWidgets('should display tag filters with FilterChip',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle tag filter selection',
          (WidgetTester tester) async {
      ...
      testWidgets('should display time filters with ChoiceChip',
          (WidgetTester tester) async {
      ...
      testWidgets('should show Swedish time filter labels',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle time filter selection',
          (WidgetTester tester) async {
    ...
    group('Advanced Filter Stats Tests', () {
      testWidgets('should display FilterStatusChip when filters active',
          (WidgetTester tester) async {
      ...
      testWidgets('should build advanced stats with filter parts',
          (WidgetTester tester) async {
      ...
      testWidgets('should generate time filter labels correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle empty filter parts properly',
          (WidgetTester tester) async {
    ...
    group('Recipe List Display Tests', () {
      testWidgets('should display recipe list with ListView.builder',
          (WidgetTester tester) async {
      ...
      testWidgets('should use ContentCard for recipe display',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle empty recipe list with StateWidget.empty',
          (WidgetTester tester) async {
      ...
      testWidgets('should navigate to recipe detail on tap',
          (WidgetTester tester) async {
      ...
      testWidgets('should use ValueKey for recipe items',
          (WidgetTester tester) async {
    ...
    group('Import Button System Tests', () {
      testWidgets('should display import buttons in SafeArea',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'should show select all button with UtilityComponents.outlinedButton',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'should show primary import button with UtilityComponents.primaryButton',
          (WidgetTester tester) async {
      ...
      testWidgets('should display dynamic import button text',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle import button loading states',
          (WidgetTester tester) async {
    ...
    group('Import Operations Tests', () {
      testWidgets('should handle import workflow coordination',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle selection-based vs all import logic',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'should show success feedback with UtilityComponents.showSuccessSnackbar',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle navigation after successful import',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'should show error feedback with UtilityComponents.showErrorSnackbar',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle error clearing in import workflow',
          (WidgetTester tester) async {
    ...
    group('Error Handling Tests', () {
      testWidgets('should display error icon in AppBar when hasError',
          (WidgetTester tester) async {
      ...
      testWidgets('should show error tooltip on error icon',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'should handle error icon tap with UtilityComponents.showErrorSnackbar',
          (WidgetTester tester) async {
      ...
      testWidgets('should clear error after showing error snackbar',
          (WidgetTester tester) async {
    ...
    group('Loading States Tests', () {
      testWidgets(
          'should display loading overlay with UtilityComponents.loadingOverlay',
          (WidgetTester tester) async {
      ...
      testWidgets('should show Swedish loading message',
          (WidgetTester tester) async {
      ...
      testWidgets('should coordinate loading state with isImporting',
          (WidgetTester tester) async {
      ...
      testWidgets('should disable buttons during import operations',
          (WidgetTester tester) async {
    ...
    group('Swedish Localization Tests', () {
      testWidgets('should display Swedish filter labels',
          (WidgetTester tester) async {
      ...
      testWidgets('should show Swedish empty state messages',
          (WidgetTester tester) async {
      ...
      testWidgets('should display Swedish success feedback',
          (WidgetTester tester) async {
    ...
    group('UtilityComponents Integration Tests', () {
      testWidgets('should integrate with UtilityComponents.showSuccessSnackbar',
          (WidgetTester tester) async {
      ...
      testWidgets('should integrate with UtilityComponents.showErrorSnackbar',
          (WidgetTester tester) async {
      ...
      testWidgets('should integrate with UtilityComponents.loadingOverlay',
          (WidgetTester tester) async {
      ...
      testWidgets('should integrate with UtilityComponents.primaryButton',
          (WidgetTester tester) async {
      ...
      testWidgets('should integrate with UtilityComponents.outlinedButton',
          (WidgetTester tester) async {
    ...
    group('Layout Constraints Tests', () {
      testWidgets('should constrain filter section to 35% of screen height',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle responsive layout properly',
          (WidgetTester tester) async {
      ...
      testWidgets('should coordinate Stack layout with overlay',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle scrollable content properly',
          (WidgetTester tester) async {
    ...
    group('Performance and Integration Tests', () {
      ...
      testWidgets('should handle provider architecture efficiently',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle complex UI structure efficiently',
          (WidgetTester tester) async {
        // ULTRATHINK: Test production code complex UI performance
        await tester.pumpWidget(createTestWidget());
        await tester.pump();
        await tester.pump(
            const Duration(milliseconds: 200)); // Allow complex UI rendering
      ...
      testWidgets('should handle resource management properly',
          (WidgetTester tester) async {

...
void main() {
  ...
  group('RecipeDetailView — favorite-toggle announce (BUT-905/BUT-1212)', () {
    ...
    testWidgets('a failed toggle announces the reverted (true) state, not the '
  ...
  group(
    'RecipeDetailView — cook-snap visibility wiring (BUT-1214/BUT-1231)',
    () {
      ...
      group('public recipe (dialog fires)', () {
        ...
        testWidgets('"Bara jag" choice reaches addCookSnap as '
        ...
        testWidgets(
          'confirming without changing the radio uploads sameAsRecipe',
          (tester) async {
            ...
            final l10n = l10nOf(tester);
            await tester.tap(
              inDialog(find.text(l10n.cookSnapVisibilityConfirm)),
            );
            await tester.pump();
            await tester.pump(const Duration(milliseconds: 50));
            ...
            expect(cookSnapService.addCalls, 1);
            expect(
              cookSnapService.lastVisibility,
        ...
        testWidgets(
          ...
          (tester) async {
            ...
            final sameTile = find.byKey(
              const ValueKey('cook-snap-visibility-same'),
            );
            expect(
              tester.getSemantics(sameTile),
              containsSemantics(isSelected: true),
              reason: '"Samma som receptet" must start selected',
            );
            expect(
              tester.getSemantics(onlyMeRadio()),
      ...
      testWidgets(
        'private recipe skips the dialog and uploads with sameAsRecipe',
        (tester) async {
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          expect(
            ...
            findsOneWidget,
            reason:
                '2,5 dl at factor 2 must render as 5 dl — its absence means '
          ...
          expect(
            ...
            findsNothing,
            reason:
                'the v1 string path mangles "ca 2,5 dl" to 2 dl at factor 2 '
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await withClock(Clock.fixed(DateTime(2024, 6, 1)), () async {
          ...
          final l10n = l10nOf(tester);
          expect(
            find.text(l10n.recipeSourceStaleBanner),
            findsOneWidget,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await withClock(Clock.fixed(DateTime(2024, 6, 1)), () async {
          ...
          await tester.pump(const Duration(milliseconds: 300));
          await tester.tap(
            find.text(l10n.recipeSourceReextractConfirmAction).last,
          );
          await tester.pump();
          await tester.pump(const Duration(milliseconds: 300));
        });
        ...
        expect(
          updated.core.sourceArtefact?.payload,
          sourcePayload,
          reason: 'the original source artefact must be re-passed, not dropped',
        );
        expect(
          updated.ingredients,
          isNot(['old placeholder ingredient']),
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await withClock(Clock.fixed(DateTime(2024, 6, 1)), () async {
          ...
          expect(
            find.text('recept: morotssoppa'),
            findsNothing,
            reason:
                'the extracted content must not appear when the write '

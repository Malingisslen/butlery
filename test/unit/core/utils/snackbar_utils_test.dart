...
void main() {
  group('SnackBarUtils.userFriendlyMessage', () {
    ...
    testWidgets('returns network error for connection failures', (tester) async {
      await setupContext(tester);
      final message = SnackBarUtils.userFriendlyMessage(
        testContext,
    ...
    testWidgets('returns auth error for authentication failures', (tester) async {
      await setupContext(tester);
      final message = SnackBarUtils.userFriendlyMessage(
        testContext,
    ...
    testWidgets('returns permission error for unauthorized access', (tester) async {
      await setupContext(tester);
      final message = SnackBarUtils.userFriendlyMessage(
        testContext,
    ...
    testWidgets('returns not found error for missing resources', (tester) async {
      await setupContext(tester);
      final message = SnackBarUtils.userFriendlyMessage(
        testContext,

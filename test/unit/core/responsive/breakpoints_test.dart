...
void main() {
  ...
  group('getDeviceCategoryFromWidth', () {
    test('maps each band to the right category', () {
      expect(
        Breakpoints.getDeviceCategoryFromWidth(500),
        DeviceCategory.mobile,
      );
      expect(
        Breakpoints.getDeviceCategoryFromWidth(700),
        DeviceCategory.mobileLarge,
      );
      expect(
        Breakpoints.getDeviceCategoryFromWidth(800),
        DeviceCategory.tablet,
      );
      expect(
        Breakpoints.getDeviceCategoryFromWidth(1100),
        DeviceCategory.tabletLarge,
      );
      expect(
        Breakpoints.getDeviceCategoryFromWidth(1500),
        DeviceCategory.desktop,
      );
      expect(
        Breakpoints.getDeviceCategoryFromWidth(2200),
    ...
    test('boundary inclusivity matches the < comparisons', () {
      ...
      expect(
        Breakpoints.getDeviceCategoryFromWidth(599.9),
        DeviceCategory.mobile,
      );
      expect(
        Breakpoints.getDeviceCategoryFromWidth(600),
        DeviceCategory.mobileLarge,
      );
    });
  });

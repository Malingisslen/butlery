  ...
  ModelTestBase.testModelGroup('RecipeChange', () {
    ...
    group('Construction', () {
      ...
      test('should preserve complete recipe state', () {
        ...
        expect(change.recipe.description, equals('Klassiska svenska köttbullar'));
        expect(change.recipe.ingredients, equals(['Köttfärs', 'Mjölk', 'Ströbröd']));
    ...
    group('Edge Cases', () {
      ...
      test('should handle very large recipe data', () {
        ...
        final largeInstructions = List.generate(100, (i) => 'Step $i: Do something');

...
void main() {
  ...
  group('AsyncOperationMixin', () {
    ...
    test('should respect custom retry count and delay', () async {
      ...
      expect(elapsed.inMilliseconds, greaterThanOrEqualTo(50)); // At least one delay
    });
  ...
  group('ValidationMixin', () {
    ...
    test('should validate email field', () {
      ...
      expect(viewModel.getValidationError('email'), equals('Ogiltig e-postadress'));
    ...
    test('should validate password field', () {
      ...
      expect(viewModel.getValidationError('password'), equals('Lösenord krävs'));
      
      // Too short password
      viewModel.updatePassword('12345');
      expect(viewModel.getValidationError('password'), equals('Lösenordet måste vara minst 6 tecken'));

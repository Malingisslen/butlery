...
''';
    ...
    group('Initialization and Default State', () {
      ...
      test('should have proper getter aliases for UI compatibility', () {
        ...
        expect(
          viewModel.isExporting,
          equals(viewModel.isLoading),
          reason: 'isExporting should alias isLoading',
        );
        expect(
          viewModel.errorMessage,
          equals(viewModel.error),
    ...
    group('Export Data', () {
      test('should export user data successfully', () async {
        // Arrange
        when(
          () => mockExportService.exportUserData(),
      ...
      test('should set export timestamp when data is exported', () async {
        ...
        expect(
          viewModel.exportTimestamp!.isAfter(
            beforeExport.subtract(const Duration(seconds: 1)),
          ),
          true,
        );
        expect(
          viewModel.exportTimestamp!.isBefore(
            afterExport.add(const Duration(seconds: 1)),
          ),
          true,
        );
      });
      ...
      test(
        'should prevent duplicate concurrent exports (AsyncOperationMixin)',
        () async {
          // Arrange
    ...
    group('AsyncOperationMixin Integration', () {
      ...
      test(
        'should use named operation to prevent concurrent exports',
        () async {
          // Arrange

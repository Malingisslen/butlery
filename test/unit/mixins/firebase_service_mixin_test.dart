...
void main() {
  group('Enhanced FirebaseServiceMixin Tests', () {
      ...
      test(
        ...
        () async {
          ...
          final result = await testService
              .executeFirebaseOperationWithDNSResilience<String>(
                () async =>
                    throw const SocketException('DNS resolution failed'),
    ...
    group('Enhanced Error Classification', () {
      ...
      test(
        'isRetryableFirebaseError should handle Firebase-specific errors',
        () {
          // Arrange
          ...
          // Act
          final isRetryable = testService.isRetryableFirebaseError(
            firebaseError,
          );
      ...
      test(
        'isRetryableFirebaseError should handle DNS-related error messages',
        () {
          // Arrange
      ...
      test(
        'classifyFirebaseError should classify network connectivity errors',
        () {
          // Arrange
    ...
    group('Enhanced Connectivity Testing', () {
      test(
        'checkFirebaseConnectivity should handle DNS resolution failures',
        () async {
    ...
    group('Enhanced Retry Operations', () {
      test(
        'executeFirebaseOperationWithRetry should include DNS failover flag',
        () async {
          // Arrange
          ...
          // Act
          final result = await testService
              .executeFirebaseOperationWithRetry<String>(
                () async => testData,
  ...
  group('FirebaseErrorType Enum Tests', () {
    test('should have all expected error types', () {
      ...
      expect(
        FirebaseErrorType.values,
        contains(FirebaseErrorType.dnsResolution),
      );
      expect(
        FirebaseErrorType.values,
      ...
      expect(
        FirebaseErrorType.values,
        contains(FirebaseErrorType.authentication),
      );
      expect(
        FirebaseErrorType.values,
        contains(FirebaseErrorType.serviceError),
      );
    ...
    test('should support string representation', () {
      ...
      expect(
        FirebaseErrorType.networkConnectivity.name,

  ...
  group('FriendsRepository Mock Tests', () {
    ...
    group('Friend Requests', () {
      test('should send friend request to another user', () async {
        ...
        verify(() => mockRepository.sendFriendRequest(toUserId, message: message)).called(1);
      });
      ...
      test('should not send duplicate friend request', () async {
        ...
        // Act
        final exists = await mockRepository.requestExists(testUser.uid, toUserId);
      ...
      test('should accept friend request', () async {
        ...
        when(() => mockRepository.addMutualFriends(friendRequest.fromUserId, friendRequest.toUserId))
            .thenAnswer((_) async {});
        
        // Act
        final success = await mockRepository.acceptFriendRequest(friendRequest.id);
        
        // Assert
        expect(success, isTrue);
        
        // Verify the method was called
        verify(() => mockRepository.acceptFriendRequest(friendRequest.id)).called(1);
      });
    ...
    group('Friend Management', () {
      ...
      test('should add mutual friends', () async {
        ...
        // Assert
        verify(() => mockRepository.addMutualFriends(userId1, userId2)).called(1);
      });
      ...
      test('should remove friend', () async {
        ...
        when(() => mockRepository.removeMutualFriends(testUser.uid, friendUserId))
            .thenAnswer((_) async {});
      ...
      test('should fetch friend profiles', () async {
        ...
        final List<String> friendIds = friendProfiles.map((p) => p.uid).toList();
    ...
    group('Friend Categories', () {
      test('should create friend category', () async {
        ...
        verify(() => mockRepository.saveCategory(testUser.uid, category)).called(1);
      });
      ...
      test('should get user categories', () async {
        ...
        // Act
        final userCategories = await mockRepository.fetchCategories(testUser.uid);
      ...
      test('should delete friend category', () async {
        ...
        // Assert
        verify(() => mockRepository.deleteCategory(testUser.uid, categoryId)).called(1);
      });
    });
    ...
    group('Group Invitations', () {
      ...
      test('should stream received invitations', () async {
        ...
        verify(() => mockRepository.receivedInvitationsStream(testUser.uid)).called(1);
      });
      ...
      test('should update invitation', () async {
        ...
        // Assert
        verify(() => mockRepository.updateInvitation(invitationId, updateData)).called(1);
      });
    });
  });
}
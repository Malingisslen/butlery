  ...
  group('MessagingRepository Mock Tests', () {
    ...
    group('Conversation Management', () {
      ...
      test('should get conversation by ID', () async {
        ...
        // Act
        final conversation = await mockRepository.getConversation(conversationId);
    ...
    group('Participant Management', () {
      ...
      test('should get conversation participants', () async {
        ...
        // Act
        final participants = await mockRepository.getConversationParticipants(conversationId);
        
        // Assert
        expect(participants, equals(expectedParticipants));
        verify(() => mockRepository.getConversationParticipants(conversationId)).called(1);
      });
    });
    ...
    group('Utility Operations', () {
      ...
      test('should get unread conversations count', () async {
        ...
        // Assert
        expect(count, equals(expectedCount));
        verify(() => mockRepository.getUnreadConversationsCount(userId)).called(1);
      });
      ...
      test('should search messages in conversation', () async {
        ...
        expect(messages.every((m) => m.content.toLowerCase().contains(query)), isTrue);

  ...
  group('UserRepository Mock Tests', () {
    ...
    group('Profile Statistics', () {
      ...
      test('should update online status', () async {
        ...
        // Assert
        verify(() => mockRepository.updateOnlineStatus(userId, isOnline)).called(1);
      });
    });
    ...
    group('Search Operations', () {
      ...
      test('should check display name availability', () async {
        ...
        // Act
        final isTakenAvailable = await mockRepository.isDisplayNameAvailable(takenName);
        final isAvailableAvailable = await mockRepository.isDisplayNameAvailable(availableName);
        
        // Assert
        expect(isTakenAvailable, isFalse);
        expect(isAvailableAvailable, isTrue);
        
        verify(() => mockRepository.isDisplayNameAvailable(takenName)).called(1);
        verify(() => mockRepository.isDisplayNameAvailable(availableName)).called(1);
      });
    });
    ...
    group('Notification Management', () {
      ...
      test('should update notification settings', () async {
        ...
        // Assert
        verify(() => mockRepository.updateNotificationSettings(userId, enabled)).called(1);
      });

  ...
  group('RecipeRepository Mock Tests', () {
    ...
    group('CRUD Operations', () {
      ...
      test('should return null for non-existent recipe', () async {
        ...
        // Stub the repository method
        when(() => mockRepository.read(recipeId)).thenAnswer((_) async => null);
      ...
      test('should update recipe', () async {
        ...
        // Stub the repository method
        when(() => mockRepository.update(recipe)).thenAnswer((_) async {});
      ...
      test('should delete recipe', () async {
        ...
        // Stub the repository method
        when(() => mockRepository.delete(recipeId)).thenAnswer((_) async {});
    ...
    group('Batch Operations', () {
      test('should add multiple recipes', () async {
        ...
        // Stub the repository method
        when(() => mockRepository.addRecipes(recipes)).thenAnswer((_) async {});

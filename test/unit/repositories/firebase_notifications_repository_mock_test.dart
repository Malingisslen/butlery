  ...
  group('NotificationsRepository Mock Tests', () {
    ...
    group('Get Notifications', () {
      ...
      test('should retrieve notifications since specific date', () async {
        ...
        // Stub the repository method
        when(() => mockRepository.getUserNotifications(userId, since: cutoffDate))
        ...
        verify(() => mockRepository.getUserNotifications(userId, since: cutoffDate)).called(1);
      });
    ...
    group('Notification Preferences', () {
      test('should update notification preferences', () async {
        ...
        // Assert
        verify(() => mockRepository.updateNotificationPreferences(userId, preferences)).called(1);
      });

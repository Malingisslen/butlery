    ...
    group('CollaborativeMenuOperations', () {
      ...
      group('Menu Rating System', () {
        test('should rate menu successfully', () async {
          // Arrange
          final mockRatingsCollection =
              MockCollectionReference<Map<String, dynamic>>();
          final mockMenuDoc = MockDocumentReference<Map<String, dynamic>>();
          final mockUserRatingsCollection =
              MockCollectionReference<Map<String, dynamic>>();
          final mockUserRatingDoc =
          ...
          when(() => mockMenuDoc.collection('ratings'))
              .thenReturn(mockUserRatingsCollection);
          when(() => mockUserRatingsCollection.doc(any()))
              .thenReturn(mockUserRatingDoc);
          when(() => mockUserRatingDoc.set(any())).thenAnswer((_) async {});

          // Mock for average rating update
          final mockMenusCollection =
              MockCollectionReference<Map<String, dynamic>>();
          final mockMenuUpdateDoc =
              MockDocumentReference<Map<String, dynamic>>();

          when(() => mockFirestore.collection('shared_menus'))
              .thenReturn(mockMenusCollection);
          when(() => mockMenusCollection.doc(any()))
              .thenReturn(mockMenuUpdateDoc);
        ...
        test('should get menu ratings', () async {
          ...
          when(() => mockMenuDoc.collection('ratings'))
              .thenReturn(mockUserRatingsCollection);
          when(() => mockUserRatingsCollection.orderBy(any(),
                  descending: any(named: 'descending')))
              .thenReturn(mockUserRatingsCollection);
          when(() => mockUserRatingsCollection.get())
        ...
        test('should calculate average rating', () async {
          ...
          when(() => mockQuerySnapshot.docs)
              .thenReturn([mockQueryDoc1, mockQueryDoc2]);
      ...
      group('Menu Commenting System', () {
        test('should add comment to menu', () async {
          ...
          final mockCommentsCollection =
              MockCollectionReference<Map<String, dynamic>>();
          final mockMenuDoc = MockDocumentReference<Map<String, dynamic>>();
          final mockCommentsSubCollection =
              MockCollectionReference<Map<String, dynamic>>();
        ...
        test('should toggle comment like', () async {
          ...
          when(() => mockMenuDoc.collection('comments'))
              .thenReturn(mockCommentsSubCollection);
          when(() => mockCommentsSubCollection.doc(any()))
              .thenReturn(mockCommentDoc);
          when(() => mockCommentDoc.get())
              .thenAnswer((_) async => mockCommentSnapshot);
        ...
        test('should get comments stream', () {
          ...
          when(() => mockMenuDoc.collection('comments'))
              .thenReturn(mockCommentsSubCollection);
          when(() => mockCommentsSubCollection.orderBy(any(),
                  descending: any(named: 'descending')))
              .thenReturn(mockCommentsSubCollection);
          when(() => mockCommentsSubCollection.snapshots())
      ...
      group('Menu Templates', () {
        test('should create menu template', () async {
          ...
          when(() => mockTemplatesCollection.add(any()))
              .thenAnswer((_) async => mockTemplateDoc);

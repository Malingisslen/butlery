  ...
  group('PersonalRecipeModule', () {
    ...
    group('Personal Recipe CRUD', () {
      test('should create personal recipe successfully', () async {
        ...
        when(() => mockServiceAdapter.createRecipe(any()))
      ...
      test('should update personal recipe successfully', () async {
        ...
        when(() => mockCacheHelper.saveJson(any(), any()))
            .thenAnswer((_) async => true);
        when(() => mockServiceAdapter.updateRecipe(any()))
            .thenAnswer((_) async => true);
      ...
      test('should delete personal recipe successfully', () async {
        ...
        when(() => mockServiceAdapter.deleteRecipe(any()))
            .thenAnswer((_) async => true);
        ...
        verify(() => mockServiceAdapter.deleteRecipe('test-recipe-1'))
            .called(1);
      });
    ...
    group('Recipe Content Operations', () {
      test('should add ingredient to recipe', () async {
        // Act
        final success =
            await module.addIngredient('test-recipe-1', '2 dl mjölk');
      ...
      test('should update ingredient at index', () async {
        // Act
        final success =
            await module.updateIngredient('test-recipe-1', 0, '600g köttfärs');
      ...
      test('should add instruction to recipe', () async {
        // Act
        final success = await module.addInstruction(
            'test-recipe-1', 'Servera med potatismos');
      ...
      test('should update instruction at index', () async {
        // Act
        final success = await module.updateInstruction(
            'test-recipe-1', 0, 'Blanda försiktigt');
      ...
      test('should fail content operations when not authenticated', () async {
        ...
        // Act
        final addIngredient =
            await module.addIngredient('test-recipe-1', 'test');
        final updateIngredient =
            await module.updateIngredient('test-recipe-1', 0, 'test');
        final removeIngredient =
            await module.removeIngredient('test-recipe-1', 0);
    ...
    group('Cache Operations', () {
      ...
      test('should delete corrupted cached recipes', () async {
        // Arrange
        when(() => mockCacheHelper.getAllKeys())
            .thenAnswer((_) async => ['corrupt-recipe']);
        when(() => mockCacheHelper.loadJson('corrupt-recipe'))
            .thenAnswer((_) async => {'invalid': 'data'});
        when(() => mockCacheHelper.delete('corrupt-recipe'))
            .thenAnswer((_) async => true);
    ...
    group('Repository Operations', () {
      ...
      test('should get personal recipes list', () async {
        ...
        verify(() => mockRepository.fetchUserRecipes('test-user-123'))
            .called(1);
      });
    ...
    group('Import/Export Functionality', () {
      ...
      test('should fail import when not authenticated', () async {
        ...
        // Act
        final importedIds =
            await module.importRecipesFromData([testRecipe.toJson()]);

        // Assert
        expect(importedIds, isEmpty);
        expect(lastError,
            equals('Du måste vara inloggad för att importera recept'));
      });
    });

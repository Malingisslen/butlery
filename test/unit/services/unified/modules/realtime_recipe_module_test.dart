  ...
  group('RealtimeRecipeModule', () {
    ...
    group('Real-time Editing Session Management', () {
      test('should start real-time editing session', () async {
        // Arrange
        await fakeFirestore.collection('unified_collaborative_recipes').doc('recipe_1').set({
      ...
      test('should handle multiple editing sessions', () async {
        ...
        await fakeFirestore.collection('unified_collaborative_recipes').doc('recipe_2').set({
          'title': 'Recipe 2',
          'activeEditors': {},
        });
        ...
        expect(realtimeModule.activeEditingSessions, containsAll(['recipe_1', 'recipe_2']));
      });
    ...
    group('Real-time Content Operations', () {
      test('should update recipe title in real-time', () async {
        ...
        // Assert
        final doc = await fakeFirestore.collection('unified_collaborative_recipes').doc('recipe_1').get();
      ...
      test('should update recipe description in real-time', () async {
        ...
        // Act
        await realtimeModule.updateDescriptionRealtime('recipe_1', 'Updated description');
      ...
      test('should add ingredient in real-time', () async {
        ...
        // Act
        await realtimeModule.addIngredientRealtime('recipe_1', 'ingredient3', null);
      ...
      test('should update ingredient in real-time', () async {
        ...
        // Act
        await realtimeModule.updateIngredientRealtime('recipe_1', 0, 'updated_ingredient1');
    ...
    group('Active Editor Management', () {
      test('should get active editors for recipe', () async {
        ...
        await fakeFirestore.collection('unified_collaborative_recipes').doc('recipe_1').set({
          'activeEditors': {
            'user_1': {'displayName': 'User 1', 'lastActive': DateTime.now().toIso8601String()},
            'user_2': {'displayName': 'User 2', 'lastActive': DateTime.now().toIso8601String()},
          },
        });
      ...
      test('should check if user is active editor', () async {
        ...
        await fakeFirestore.collection('unified_collaborative_recipes').doc('recipe_1').set({
          'activeEditors': {
            'user_123': {'displayName': 'Test User', 'lastActive': DateTime.now().toIso8601String()},
          },
        });
        
        // Act
        final activeEditorsList = await realtimeModule.getActiveEditors('recipe_1');
        final isActive = activeEditorsList.any((editor) => editor['userId'] == 'user_123');
        final isNotActive = activeEditorsList.any((editor) => editor['userId'] == 'user_456');
      ...
      test('should clean up stale editors', () async {
        ...
        await fakeFirestore.collection('unified_collaborative_recipes').doc('recipe_1').set({
          'activeEditors': {
            'user_1': {'displayName': 'User 1', 'lastActive': staleTime.toIso8601String()},
            'user_2': {'displayName': 'User 2', 'lastActive': DateTime.now().toIso8601String()},
          },
        });
        ...
        // Assert
        final doc = await fakeFirestore.collection('unified_collaborative_recipes').doc('recipe_1').get();
        final activeEditors = doc.data()?['activeEditors'] as Map<String, dynamic>?;

  ...
  group('SocialEngagementMetrics', () {
    ...
    group('Recipe Engagement Metrics', () {
      test('should calculate basic engagement metrics for personal recipe', () {
        // Act
        final metrics = SocialEngagementMetrics.calculateRecipeEngagement(personalRecipe);
      ...
      test('should calculate higher engagement for collaborative recipe', () {
        // Act
        final metrics = SocialEngagementMetrics.calculateRecipeEngagement(collaborativeRecipe);
        ...
        expect(metrics['engagement_score'], greaterThan(40)); // Multiple members contribute to score
      });
      ...
      test('should include recency in engagement score', () {
        ...
        // Act
        final metrics = SocialEngagementMetrics.calculateRecipeEngagement(recentRecipe);
      ...
      test('should calculate engagement level correctly', () {
        // Act
        final lowEngagement = SocialEngagementMetrics.calculateRecipeEngagement(personalRecipe);
        final highEngagement = SocialEngagementMetrics.calculateRecipeEngagement(collaborativeRecipe);
      ...
      test('should factor in recipe complexity', () {
        // Act
        final simpleMetrics = SocialEngagementMetrics.calculateRecipeEngagement(personalRecipe);
        final complexMetrics = SocialEngagementMetrics.calculateRecipeEngagement(complexRecipe);
      ...
      test('should handle error gracefully', () {
        ...
        // Act
        final metrics = SocialEngagementMetrics.calculateRecipeEngagement(invalidRecipe);
    ...
    group('Recipe Completeness', () {
      test('should calculate completeness score for minimal recipe', () {
        ...
        final metrics = SocialEngagementMetrics.calculateRecipeEngagement(minimalRecipe);
        final factors = metrics['engagement_factors'] as Map<String, dynamic>;
      ...
      test('should calculate completeness score for complete recipe', () {
        // Act
        final metrics = SocialEngagementMetrics.calculateRecipeEngagement(complexRecipe);
        final factors = metrics['engagement_factors'] as Map<String, dynamic>;
        
        // Assert - Complete recipe should have high completeness
        expect(factors['completeness_contribution'], greaterThan(4)); // Adjusted for actual scale
      });
    });
    ...
    group('Error Handling', () {
      test('should handle Firestore errors gracefully', () async {
        ...
        final stats = await SocialEngagementMetrics.calculateUserSocialStats(
          ...
          userId: 'user_123',
          userRecipes: [personalRecipe], // Need a recipe to trigger Firestore calls
        );

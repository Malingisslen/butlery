    ...
    group('Rating Notifications', () {
      ...
      test('should format rating notification with stars', () async {
        ...
        when(() => mockNotificationService.sendImmediateNotification(
          ...
          final variables = invocation.namedArguments[#variables] as Map<String, String>;
        ...
        expect(capturedMessage, contains('Betygsatte ditt recept')); // Swedish message
      });
      ...
      test('should truncate long review text', () async {
        ...
        final longReview = 'This is a very long review that exceeds fifty characters and should be truncated';
      ...
      test('should handle collaborative recipe with socialData ownerId', () async {
        // Arrange
        when(() => mockNotificationService.sendImmediateNotification(
    ...
    group('Milestone Notifications', () {
      ...
      test('should include milestone type for 25 ratings', () async {
        ...
        when(() => mockNotificationService.sendImmediateNotification(
          ...
          capturedData = invocation.namedArguments[#additionalData] as Map<String, dynamic>;
        });
    ...
    group('Summary Notifications', () {
      ...
      test('should include period in summary data', () async {
        ...
        await RatingNotifications.sendRatingSummaryNotification(
          notificationService: mockNotificationService,
          userId: 'user_123',
          recipeRatingSummaries: [{'recipeName': 'Test', 'newRatings': 1, 'averageRating': 4.0}],
          period: 'monthly',
        );
    ...
    group('Notification Formatting', () {
      ...
      test('should include rating action in notification', () async {
        ...
        when(() => mockNotificationService.sendImmediateNotification(
          ...
          capturedActions = invocation.namedArguments[#actions] as List<NotificationAction>?;
        });

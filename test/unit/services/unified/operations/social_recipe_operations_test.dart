...
// Using MockUnifiedRecipeService from production_mocks.dart

// Mock classes for the modules
class MockRecipeSharingManager extends Mock implements RecipeSharingManager {}
class MockRecipeMemberManager extends Mock implements RecipeMemberManager {}
class MockRecipeCommentsManager extends Mock implements RecipeCommentsManager {}
class MockRecipeDiscoveryService extends Mock implements RecipeDiscoveryService {}
class MockRecipeSocialStats extends Mock implements RecipeSocialStats {}
class MockRecipePermissionHelper extends Mock implements RecipePermissionHelper {}
  ...
  group('SocialRecipeOperations', () {
    ...
    group('Recipe Sharing', () {
      ...
      test('should convert collaborative recipe to personal', () async {
        // Arrange
        final collaborativeRecipe = RecipeBuilder()
            .withId('collab-123')
            .asCollaborative()
            .build();
    ...
    group('Permissions', () {
      ...
      test('should get user permission for recipe', () {
        ...
        // Act
        final permission = operations.getUserPermission('recipe-123', 'user-123');
      ...
      test('should get permission summary', () {
        ...
        // Act
        final summary = operations.getPermissionSummary('recipe-123', 'user-123');
      ...
      test('should return error for non-existent recipe permission check', () {
        ...
        final permission = operations.getUserPermission('non-existent', 'user-123');

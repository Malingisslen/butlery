...
void main() {
  group('PersonalShoppingOperations', () {
    ...
    setUpAll(() async {
      ...
      registerFallbackValue(UnifiedShoppingItem.basic(name: 'fallback', amount: 1));
    });
    ...
    group('List CRUD Operations', () {
      test('should create personal list successfully', () async {
        ...
        verify(() => mockParent.createPersonalList('Ny lista', items: null)).called(1);
      });
      ...
      test('should create list with initial items', () async {
        ...
        // Act
        final result = await operations.createList('Frukostlista', items: items);
        
        // Assert
        expect(result, equals('new-list-id'));
        verify(() => mockParent.createPersonalList('Frukostlista', items: items)).called(1);
      });
      ...
      test('should rename list successfully', () async {
        ...
        // Act
        final result = await operations.renameList('test-list-1', 'Månadshandling');
        
        // Assert
        expect(result, isTrue);
        verify(() => mockParent.renameList('test-list-1', 'Månadshandling')).called(1);
      });
    ...
    group('List Analysis', () {
      ...
      test('should get items grouped by category', () {
        ...
        expect(categoryMap['Mejeri']![0].name, equals('Mjölk')); // Sorted by priority
    ...
    group('Import Functionality', () {
      ...
      test('should clear existing items when clearExisting is true', () async {
        ...
        final capturedList = verify(() => mockParent.updateList(captureAny())).captured.single as UnifiedShoppingList;
    ...
    group('Advanced Item Operations', () {
      ...
      test('should manage item priorities correctly', () async {
        // Arrange
        final prioritizedItems = List.generate(5, (i) => 
          UnifiedShoppingItem(
            id: 'item-$i',
            name: 'Item $i',
            amount: 1.0,
    ...
    group('Swedish Language Support', () {
      ...
      test('should handle Swedish category names and sorting', () {
        // Arrange
        final swedishItems = [
          UnifiedShoppingItem(id: '1', name: 'Mjölk', category: 'Mejeri', amount: 1.0, bought: false),
          UnifiedShoppingItem(id: '2', name: 'Bröd', category: 'Bageri', amount: 1.0, bought: false),
          UnifiedShoppingItem(id: '3', name: 'Äpplen', category: 'Frukt & Grönt', amount: 1.0, bought: false),
          UnifiedShoppingItem(id: '4', name: 'Kött', category: 'Kött & Fisk', amount: 1.0, bought: false),
          UnifiedShoppingItem(id: '5', name: 'Öl', category: 'Drycker', amount: 1.0, bought: false),
        ];
        ...
        // Assert
        expect(categoryMap.keys, containsAll([
          'Mejeri',
          'Bageri',
          'Frukt & Grönt',
          'Kött & Fisk',
    ...
    group('Performance and Concurrency', () {
      test('should handle large lists efficiently', () {
        // Arrange
        final largeItemList = List.generate(150, (i) =>
          UnifiedShoppingItem(
            id: 'item-$i',
            name: 'Product ${i + 1}',
    ...
    group('Template Operations', () {
      test('should create list from template', () async {
        // Arrange
        final templateItems = [
          UnifiedShoppingItem(id: '1', name: 'Mjölk', amount: 2.0, unit: 'l', category: 'Mejeri', bought: false),
          UnifiedShoppingItem(id: '2', name: 'Bröd', amount: 1.0, unit: 'st', category: 'Bageri', bought: false),
          UnifiedShoppingItem(id: '3', name: 'Ägg', amount: 12.0, unit: 'st', category: 'Mejeri', bought: false),
        ];
        ...
        expect(items.every((item) => !item.bought), isTrue); // All items start unchecked
      });
      
      test('should save current list as template', () {
        // Arrange
        final currentItems = [
          UnifiedShoppingItem(id: '1', name: 'Standardvara 1', amount: 1.0, bought: true, category: 'Test'),
          UnifiedShoppingItem(id: '2', name: 'Standardvara 2', amount: 2.0, bought: false, category: 'Test'),
        ];
        ...
        expect(exportedItems[1]['bought'], isFalse); // Second item wasn't bought
      });
      
      test('should apply template to existing list', () async {
        // Arrange
        final templateItems = [
          UnifiedShoppingItem(id: 'new-1', name: 'Mall Vara 1', amount: 1.0, category: 'Kategori 1', bought: false),
          UnifiedShoppingItem(id: 'new-2', name: 'Mall Vara 2', amount: 2.0, category: 'Kategori 2', bought: false),
        ];
        
        when(() => mockParent.updateList(any())).thenAnswer((_) async => true);
        
        // Act - Apply template (merge with existing)
        final itemTexts = templateItems.map((item) => 
    ...
    group('Advanced Analytics', () {
      test('should analyze historical buying patterns', () {
        ...
        final historicalItems = [
          UnifiedShoppingItem(
            id: '1', name: 'Mjölk', amount: 2.0, unit: 'l',
            bought: true, category: 'Mejeri',
            purchasedAt: now.subtract(Duration(days: 7)),
          ),
          UnifiedShoppingItem(
            id: '2', name: 'Mjölk', amount: 2.0, unit: 'l',
            bought: true, category: 'Mejeri',
            purchasedAt: now.subtract(Duration(days: 14)),
          ),
          UnifiedShoppingItem(
            id: '3', name: 'Mjölk', amount: 2.0, unit: 'l',
            bought: true, category: 'Mejeri',
        ...
        final milkItems = historicalItems.where((item) => item.name == 'Mjölk').toList();
      ...
      test('should identify frequent items', () {
        // Arrange
        final frequentItems = [
          UnifiedShoppingItem(id: '1', name: 'Mjölk', amount: 2.0, bought: true, category: 'Mejeri'),
          UnifiedShoppingItem(id: '2', name: 'Bröd', amount: 1.0, bought: true, category: 'Bageri'),
          UnifiedShoppingItem(id: '3', name: 'Mjölk', amount: 2.0, bought: false, category: 'Mejeri'),
          UnifiedShoppingItem(id: '4', name: 'Ägg', amount: 12.0, bought: true, category: 'Mejeri'),
          UnifiedShoppingItem(id: '5', name: 'Mjölk', amount: 2.0, bought: true, category: 'Mejeri'),
          UnifiedShoppingItem(id: '6', name: 'Bröd', amount: 1.0, bought: false, category: 'Bageri'),
        ];
        ...
        expect(mejeriItems.where((item) => item.name == 'Mjölk').length, equals(3));
        // Bröd appears 2 times
        expect(breadItems.where((item) => item.name == 'Bröd').length, equals(2));
      });
      ...
      test('should calculate cost estimation and budget tracking', () {
        ...
        final pricedItems = [
          UnifiedShoppingItem(
            id: '1', name: 'Mjölk', amount: 2.0, unit: 'l',
            estimatedPrice: 25.90, bought: false, category: 'Mejeri',
          ),
          UnifiedShoppingItem(
            id: '2', name: 'Bröd', amount: 1.0, unit: 'st',
            estimatedPrice: 32.50, bought: false, category: 'Bageri',
          ),
          UnifiedShoppingItem(
            id: '3', name: 'Ägg', amount: 12.0, unit: 'st',
            estimatedPrice: 45.90, bought: true, category: 'Mejeri',
          ),
          UnifiedShoppingItem(
            id: '4', name: 'Ost', amount: 500.0, unit: 'g',
            estimatedPrice: 89.90, bought: false, category: 'Mejeri',
          ),
        ];

  ...
  group('AuthService', () {
    ...
    group('Password Reset', () {
      test('should send password reset email', () async {
        ...
        // Assert
        expect(result, true);
        verify(() => mockAuthRepository.sendPasswordResetEmail('test@example.com'))
            .called(1);
      });
      ...
      test('should handle password reset errors', () async {
        ...
        // Act
        final result = await authService.sendPasswordResetEmail('unknown@example.com');
    ...
    group('Error Handling', () {
      test('should translate Firebase error codes to Swedish messages', () async {
    ...
    group('Firebase Auth Error Scenarios', () {
      test('should handle user-not-found error', () async {
        ...
        // Assert
        expect(result, false);
        expect(authService.errorMessage, equals('Ingen användare hittades med denna email.'));
      });
      ...
      test('should handle user-disabled error', () async {
        ...
        // Assert
        expect(result, false);
        expect(authService.errorMessage, equals('Detta konto har inaktiverats.'));
      });
      ...
      test('should handle unknown Firebase error codes gracefully', () async {
        ...
        expect(result, false);
        expect(authService.errorMessage, contains('Autentiseringsfel'));
        expect(authService.errorMessage, contains('Something unexpected happened'));
      });
    });
    ...
    group('Concurrent Operation Errors', () {
      ...
      test('should handle sign out during sign in', () async {
        ...
        expect(signInResult, true); // Sign in completes as it was already in progress
        verify(() => mockAuthRepository.signOut()).called(1);
        verify(() => mockAuthRepository.signIn(
          email: 'test@example.com',
          password: 'password',
    ...
    group('Error Recovery', () {
      ...
      test('should handle error during error recovery', () async {
        ...
        // Act
        final result1 = await authService.sendPasswordResetEmail('unknown@example.com');
        ...
        // Act
        final result2 = await authService.sendPasswordResetEmail('test@example.com');

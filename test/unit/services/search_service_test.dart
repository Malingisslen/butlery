  ...
  group('SearchService', () {
    ...
    group('Filter by Tags', () {
      ...
      test('should filter recipes by multiple tags (AND logic)', () {
        final results = service.filterByTags(testRecipes, ['italiensk', 'pasta']);
    ...
    group('Filter by Portions', () {
      ...
      test('should filter recipes by portion range', () {
        ...
        expect(results.length, equals(3));
        expect(results.every((r) => r.portions! >= 3 && r.portions! <= 5), isTrue);
      });
    });
    ...
    group('Search Suggestions', () {
      ...
      test('should limit suggestions to 10', () {
        ...
        final manyRecipes = List.generate(20, (i) => 
          RecipeFactory.build(
            title: 'Recipe $i',

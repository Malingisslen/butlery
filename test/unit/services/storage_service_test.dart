  ...
  group('StorageService', () {
    ...
    group('Image Upload', () {
      test('should handle single image upload', () async {
        ...
        const expectedUrl = 'https://storage.googleapis.com/test/users/test_user_123/recipes/recipe_123.jpg';
        ...
        when(() => mockRepository.createAndUploadThumbnail(
          ...
          userId: any(named: 'userId'),
          originalPath: any(named: 'originalPath'),
        )).thenAnswer((_) async => 'https://storage.googleapis.com/test/thumb.jpg');

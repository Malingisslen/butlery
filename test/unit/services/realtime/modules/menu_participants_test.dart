  ...
  group('MenuParticipants', () {
    ...
    group('Permission Queries', () {
      test('should check if user is participant', () {
        ...
        expect(MenuParticipants.isParticipant(menu, 'owner_123'), false); // Owner not in participants map
      });
      ...
      test('should get all editor IDs', () {
        ...
        expect(editors, isNot(contains('owner_123'))); // Owner not in participants
      ...
      test('should recognize owner special privileges', () {
        // Arrange
        final menu = menuBuilder.withOwner('special_owner', 'Owner Name').build();
    ...
    group('Analytics', () {
      test('should generate participant summary', () {
        ...
        expect(summary['totalParticipants'], 3); // 3 participants (owner not counted)
      ...
      test('should handle empty participants gracefully', () {
        ...
        expect(summary['totalParticipants'], 0); // No participants (owner not counted)
    ...
    group('Batch Operations', () {
      ...
      test('should handle removing multiple participants', () {
        ...
        var updated = MenuParticipants.removeParticipant(menu, userId: 'user_2');
    ...
    group('Permission Hierarchy Extended', () {
      test('should correctly order permission levels', () {
        // Arrange & Act
        final readLevel = MenuParticipants.getPermissionLevel(ResourcePermission.read);
        final viewerLevel = MenuParticipants.getPermissionLevel(ResourcePermission.viewer);
        final writeLevel = MenuParticipants.getPermissionLevel(ResourcePermission.write);
        final editorLevel = MenuParticipants.getPermissionLevel(ResourcePermission.editor);
        final adminLevel = MenuParticipants.getPermissionLevel(ResourcePermission.admin);
        final ownerLevel = MenuParticipants.getPermissionLevel(ResourcePermission.owner);
    ...
    group('Validation and State', () {
      ...
      test('should find participant permission by ID', () {
        ...
        // Act
        final permission = MenuParticipants.findParticipantPermission(menu, 'user_123');
    ...
    group('Edge Cases', () {
      ...
      test('should handle participants with all permission types', () {
        ...
        // Act
        final participantsByPermission = MenuParticipants.getParticipantIdsByPermission(menu);
      ...
      test('should format participant list for display', () {
        // Arrange
        final emptyMenu = menuBuilder.withOwner('owner_123', 'Test Owner').build();
        final collabMenu = menuBuilder
        ...
        // Act
        final emptyDisplay = MenuParticipants.getParticipantListString(emptyMenu);
        final collabDisplay = MenuParticipants.getParticipantListString(collabMenu);

  ...
  group('DeepLinkService', () {
    ...
    group('Recipe Share Links', () {
      ...
      test('should include custom message for recipe sharing', () {
        ...
        // Assert
        expect(link, contains('message=Try%2520this%2520amazing%2520recipe%21'));
      });
    });
    ...
    group('Shopping List Share Links', () {
      ...
      test('should generate different timestamps for sequential calls', () async {
        // Act
    ...
    group('Deep Link Parsing', () {
      test('should parse valid friend invitation link', () {
        // Arrange
        final link = 'https://butlery.app/invite?id=inv123&type=friend&from=user456&timestamp=1234567890000';
      ...
      test('should parse recipe share link with message', () {
        // Arrange
        final link = 'https://butlery.app/recipe?id=recipe789&type=recipe&from=user456&message=Try%20this!&timestamp=1234567890000';
      ...
      test('should parse menu share link', () {
        // Arrange
        final link = 'https://butlery.app/menu?id=menu321&type=menu&from=user456&timestamp=1234567890000';
      ...
      test('should parse shopping list share link', () {
        // Arrange
        final link = 'https://butlery.app/shopping?id=list999&type=shopping&from=user456&timestamp=1234567890000';
      ...
      test('should handle www subdomain', () {
        // Arrange
        final link = 'https://www.butlery.app/invite?id=inv123&type=friend&from=user456';
      ...
      test('should handle malformed timestamp', () {
        // Arrange
        final link = 'https://butlery.app/invite?id=inv123&timestamp=not-a-number';
    ...
    group('Link Validity', () {
      ...
      test('should validate links at the edge of expiration', () {
        ...
        final linkData = DeepLinkData(
          type: DeepLinkType.friendInvitation,
          id: 'inv123',
          timestamp: DateTime.now().subtract(Duration(days: 6, hours: 23)).millisecondsSinceEpoch,
        );
      ...
      test('should accept custom max age', () {
        ...
        // Act
        final isValid = DeepLinkService.isLinkValid(linkData, maxAge: Duration(hours: 1));
    ...
    group('Link Expiration', () {
      ...
      test('should identify non-expired links', () {
        ...
        final linkData = DeepLinkData(
          type: DeepLinkType.recipeShare,
          id: 'recipe123',
          timestamp: DateTime.now().subtract(Duration(days: 5)).millisecondsSinceEpoch,
        );
    ...
    group('Short URL Generation', () {
      test('should generate internal short URL when authenticated', () async {
        ...
        final shortUrl = await DeepLinkService.generateShortUrl('https://butlery.app/recipe?id=123');
      ...
      test('should include expiration metadata', () async {
        ...
        // Act
        await DeepLinkService.generateShortUrl('https://butlery.app/recipe?id=123');
    ...
    group('Deep Link Handling', () {
      test('should navigate to friend invitation route', () async {
        // Arrange
        final link = 'https://butlery.app/invite?id=inv123&type=friend&from=user456&timestamp=${DateTime.now().millisecondsSinceEpoch}';
      ...
      test('should navigate to recipe share route', () async {
        // Arrange
        final link = 'https://butlery.app/recipe?id=recipe789&type=recipe&from=user456&timestamp=${DateTime.now().millisecondsSinceEpoch}';
      ...
      test('should navigate to menu share route', () async {
        // Arrange
        final link = 'https://butlery.app/menu?id=menu321&type=menu&from=user456&timestamp=${DateTime.now().millisecondsSinceEpoch}';
      ...
      test('should navigate to shopping list share route', () async {
        // Arrange
        final link = 'https://butlery.app/shopping?id=list999&type=shopping&from=user456&timestamp=${DateTime.now().millisecondsSinceEpoch}';
      ...
      test('should not navigate for expired links', () async {
        // Arrange
        final link = 'https://butlery.app/invite?id=inv123&type=friend&from=user456&timestamp=${DateTime.now().subtract(Duration(days: 10)).millisecondsSinceEpoch}';
      ...
      test('should not navigate when id is missing', () async {
        // Arrange
        final link = 'https://butlery.app/invite?type=friend&from=user456&timestamp=${DateTime.now().millisecondsSinceEpoch}';
    ...
    group('Error Handling', () {
      group('Deep Link Parsing Errors', () {
        ...
        test('should handle missing required parameters', () {
          // Arrange
          final link = 'https://butlery.app/invite'; // missing all query parameters
          ...
          if (data != null) {
            ...
            expect(data.type == DeepLinkType.friendInvitation || data.type == null, isTrue);
          }
        });
        ...
        test('should handle various URL schemes', () {
          ...
          for (final link in testSchemes) {
            ...
            if (link.contains('butlery.app')) {
              ...
              expect(data, isNull, reason: 'Should reject custom scheme: $link');
            }
          }
        });
        ...
        test('should handle invalid character encoding', () {
          ...
          for (final link in links) {
            ...
            if (data != null && data.id != null) {
              ...
              expect(data.id == null || data.id!.contains('%') || data.id!.isNotEmpty, isTrue);
            }
          }
        });
      });
      ...
      group('Navigation Errors', () {
        ...
        test('should prevent stack overflow from recursive navigation', () async {
          // Arrange
      ...
      group('Permission Errors', () {
        test('should handle access to private recipe without permission', () async {
          // Arrange
          mockPermissionService.setPermissionState(
        ...
        test('should handle access to deleted content', () async {
          ...
          // Act
          final longUrl = await DeepLinkService.resolveShortUrl('deleted_content');
      ...
      group('Dynamic Link Errors', () {
        test('should handle Firebase Dynamic Links failure', () async {
          ...
          // Assert
          expect(shortUrl, equals('https://butlery.app/recipe?id=123')); // Fallback
        });
        ...
        test('should handle short link generation failure', () async {
          ...
          // Assert
          expect(shortUrl, equals('https://butlery.app/menu?id=456')); // Fallback
        });
        ...
        test('should handle link analytics tracking error', () async {
          ...
          expect(longUrl, isNull); // Due to ServiceLocator issue in static method
        });
        ...
        test('should handle rate limit on link generation', () async {
          ...
          expect(results.where((url) => url.startsWith('https://butlery.app')).length,
              greaterThan(0));
        });
      });
      ...
      group('App State Errors', () {
        ...
        test('should handle background/terminated app state', () async {
          // Arrange
          const currentState = 'paused'; // Using string instead of enum for simplicity
      ...
      group('Platform-Specific Errors', () {
        test('should handle iOS Universal Links failure', () async {
          ...
          final link = 'https://butlery.app/.well-known/apple-app-site-association';
        ...
        test('should handle web URL routing errors', () async {
          ...
          for (final link in webLinks) {
            final data = DeepLinkService.parseDeepLink(link);
            expect(data, isNull, reason: 'Should not parse web-specific routing: $link');
          }
        });

...
void main() {
  group('RecipeEventsTracker cooking-mode instrumentation (BUT-802 HIGH-PA4)',
      () {
    ...
    test('logCookingSessionStarted emits event with iso8601 started_at',
        () async {
    ...
    test('logCookingSessionCompleted emits with int duration + steps_viewed',
        () async {
      ...
      expect(captured.values.whereType<String>(),

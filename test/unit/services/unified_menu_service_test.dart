...
// Mock classes for Firebase - sealed class warnings are expected and safe in tests
  ...
  group('UnifiedMenuService', () {
    ...
    group('Initialization', () {
      ...
      test('should not re-initialize if already initialized', () async {
        ...
        // Assert
        expect(service.isInitialized, true);
        verify(() => mockQuery.get()).called(1); // Should only load once
      });

      test('should handle initialization error gracefully', () async {
        // Arrange
        when(() => mockQuery.get()).thenAnswer((_) async => throw Exception('Firebase error'));
    ...
    */
    ...
    group('Collaborative Menu Operations', () {
      ...
      test('should add recipe to collaborative menu', () async {
        ...
        final mockSharedMenusCollection = MockCollectionReference();
        final mockSharedMenuDoc = MockDocumentReference();
        final mockMenuActivityCollection = MockCollectionReference();
        final mockMenuActivityDoc = MockDocumentReference();
      ...
      test('should rate collaborative menu', () async {
        ...
        final mockRatingsDoc = MockDocumentReference();
      ...
      test('should get menu ratings', () async {
        ...
        final mockRatingsCollection = MockCollectionReference();
        final mockRatingsDoc = MockDocumentReference();
        final mockRatingSnapshot = MockQueryDocumentSnapshot();
      ...
      test('should calculate average menu rating', () async {
        ...
        final mockRatingsCollection = MockCollectionReference();
        final mockRatingsDoc = MockDocumentReference();
        final mockRatingSnapshot1 = MockQueryDocumentSnapshot();
        final mockRatingSnapshot2 = MockQueryDocumentSnapshot();
      ...
      test('should add comment to collaborative menu', () async {
        ...
        final mockCommentsDoc = MockDocumentReference();
      ...
      test('should toggle comment like', () async {
        ...
        final mockCommentsDoc = MockDocumentReference();
        final mockCommentDoc = MockDocumentReference();
        final mockCommentSnapshot = MockQueryDocumentSnapshot();
      ...
      test('should create menu from template', () async {
        ...
        final mockTemplatesCollection = MockCollectionReference();
        final mockTemplateDoc = MockDocumentReference();
        final mockTemplateSnapshot = MockQueryDocumentSnapshot();
        final mockSharedMenusCollection = MockCollectionReference();
        final mockNewMenuDoc = MockDocumentReference();

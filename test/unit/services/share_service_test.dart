  ...
  group('ShareService', () {
    ...
    group('Weekly Menu Formatting', () {
      ...
      test('should format categories menu', () {
        ...
        // Act
        final formatted = shareService.formatWeekMenuFromCategories(categoriesMenu);
    ...
    group('Edge Cases', () {
      ...
      test('should handle null values gracefully', () {
        ...
        expect(() => shareService.formatRecipeCompact(nullRecipe), returnsNormally);
        expect(() => shareService.formatRecipeMarkdown(nullRecipe), returnsNormally);
      });
      ...
      test('should handle very long content', () {
        ...
        // Act & Assert
        expect(() => shareService.formatRecipeComplete(longRecipe), returnsNormally);
        expect(() => shareService.formatRecipeCompact(longRecipe), returnsNormally);
        expect(() => shareService.formatRecipeMarkdown(longRecipe), returnsNormally);
      });

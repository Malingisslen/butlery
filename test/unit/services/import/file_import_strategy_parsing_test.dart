...
Incomplete Recipe,"Some ingredients"''';
        ...
        expect(result.recipe!.instructions, equals(['No instructions provided']));
      });
...
"Recipe, with comma","Salt, pepper, oil","Mix, stir, and cook"''';
    ...
    group('Excel Import Tests', () {
      test('should import recipe from Excel content', () async {
        ...
        // Act
        final result = await strategy.importFromContent(Uint8List.fromList(bytes), 'xlsx');
      ...
      test('should handle Excel with empty cells', () async {
        ...
        expect(result.recipe!.ingredients, equals(['No ingredients specified']));
...
Valid Recipe 3,"Final ingredients"''';
      ...
      test('should handle mixed column naming conventions', () async {
        // Arrange
        final csvContent = '''recipe_name,ingredient_list,cooking_steps,serving_size,prep_time

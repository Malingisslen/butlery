...
void main() {
  group('ExtractionManager', () {
    ...
    setUp(() async {
      ...
      // Create mocks if needed for future refactoring
      
      // Since ExtractionManager uses singletons, we need to test it differently
    ...
    group('Edge Cases', () {
      ...
      test('should handle URLs with special characters', () async {
        // Arrange
        const urlWithSpecialChars = 'https://example.com/recipe?title=Köttbullar&id=123';
    ...
    group('Multi-Source Extraction', () {
      ...
      test('should handle PDF URL extraction', () async {
        ...
        expect(result, isA<ExtractionResult>());
        expect(result.metadata['contentType'], isNull); // PDF parsing not available in tests
      });
    ...
    group('Data Validation', () {
      ...
      test('should sanitize and clean ingredient data', () async {
        ...
        if (result.extractedText != null) {
          ...
          expect(result.extractedText!.contains('  '), isFalse); // No double spaces
        }
      });
    ...
    group('Swedish Content Support', () {
      test('should handle Swedish cooking sites with special characters', () async {
        // Arrange
        const swedishSites = [
    ...
    group('Performance and Caching', () {
      ...
      test('should handle batch extraction efficiently', () async {
        // Arrange
        final urls = List.generate(10, (i) => 'https://www.example.com/recipe$i');

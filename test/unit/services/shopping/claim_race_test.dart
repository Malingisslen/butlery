...
void main() {
  group('BUT-238: claim race semantics', () {
    ...
    test('losing UI path: item already assigned to OTHER user surfaces '
      ...
      final alreadyAssignedToOther =
          alreadyHeld.assignedToUserId != null &&
    ...
    test(
      'unassign() by assignee releases — re-claim by a peer then succeeds',
      () {
    ...
    test(
      ...
      () {
        ...
        final snapshot = baseList.copyWith(
          items: [

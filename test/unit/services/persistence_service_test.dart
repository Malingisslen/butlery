  ...
  group('PersistenceService', () {
    group('Recipe Persistence', () {
      ...
      test('should load saved recipes correctly', () async {
        ...
        expect(loadedRecipes.first.core.id, equals(originalRecipes.first.core.id));
      });
      ...
      test('should preserve recipe details during save/load cycle', () async {
        ...
        expect(loadedRecipes.first.core.description, equals('Test Description'));
        expect(loadedRecipes.first.core.portions, equals(4));
        expect(loadedRecipes.first.core.timeMinutes, equals(30));
      });

      test('should update last updated timestamp when saving recipes', () async {
        SharedPreferences.setMockInitialValues({});
    ...
    group('Metadata Operations', () {
      test('should return null when no last updated timestamp exists', () async {
        SharedPreferences.setMockInitialValues({});
      ...
      test('should return last updated timestamp', () async {
        ...
        expect(lastUpdated!.toIso8601String(), equals(timestamp.toIso8601String()));
      });
    ...
    group('Edge Cases', () {
      ...
      test('should handle special characters in recipe titles', () async {
        ...
        expect(loadedRecipes.first.core.title, equals('Räksmörgås & Köttbullar'));
      ...
      test('should handle concurrent menu operations', () async {
        ...
        final saveResult = await service.saveCurrentMenu(['recipe1', 'recipe2']);
      ...
      test('should handle menu with duplicate recipe IDs', () async {
        SharedPreferences.setMockInitialValues({});
        final duplicateMenu = ['recipe1', 'recipe2', 'recipe1', 'recipe3', 'recipe2'];

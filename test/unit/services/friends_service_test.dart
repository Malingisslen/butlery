  ...
  group('Friends Service', () {
    ...
    group('Friend Categories', () {
      ...
      test('should update category members', () async {
        ...
        when(() => mockRepository.updateCategoryMembers(userId, categoryId, memberIds))
            .thenAnswer((_) async {});
        
        // Act
        await mockRepository.updateCategoryMembers(userId, categoryId, memberIds);
        
        // Assert
        verify(() => mockRepository.updateCategoryMembers(userId, categoryId, memberIds)).called(1);
      });
      ...
      test('should delete category', () async {
        ...
        // Assert
        verify(() => mockRepository.deleteCategory(userId, categoryId)).called(1);
      });

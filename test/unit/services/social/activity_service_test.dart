...
// - MockAuthRepository
// Using centralized factory from social_factory.dart for:
// - ActivityFeedItem creation (replaces FakeActivityFeedItem)
// - ActivityEngagement creation (replaces FakeActivityEngagement)
  ...
  group('ActivityService', () {
    ...
    group('Feed Operations', () {
      test('should get friend activity feed', () async {
        // Arrange
        final activities = [
          SocialFactory.createActivityFeedItem(
            id: 'activity-1',
            userId: 'friend-1',
      ...
      test('should get trending activities', () async {
        ...
        final activities = [
          SocialFactory.createActivityFeedItem(
            ...
            engagement: ActivityEngagement(likes: 100, comments: 0, shares: 0, views: 0),
          ),
        ];

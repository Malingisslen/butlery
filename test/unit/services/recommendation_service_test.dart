  ...
  group('RecommendationService', () {
    ...
    group('generateRecommendations', () {
      ...
      test('should generate similarToShared recommendations', () async {
        ...
        expect(recommendations, isNotEmpty);
        expect(recommendations.first.type,
            equals(RecommendationType.similarToShared));
      });
      ...
      test('should generate trending recommendations', () async {
        ...
        expect(recommendations, isNotEmpty);
        expect(recommendations.first.type,
            equals(RecommendationType.trendingForYou));
      });
      ...
      test('should generate friend-based recommendations', () async {
        ...
        expect(recommendations, isNotEmpty);
        expect(recommendations.first.type,
            equals(RecommendationType.basedOnFriends));
      });
      ...
      test('should track dismissals', () async {
        ...
        if (recommendations.isNotEmpty) {
          ...
          expect(
              service.getRecommendation(recommendations.first.id), isNotNull);
        }
      });
    ...
    group('Recommendation model', () {
      test('should create recommendation with all fields', () {
        ...
        expect(
            recommendation.imageUrl, equals('https://example.com/image.jpg'));
    ...
    group('dismissRecommendation', () {
      test('should dismiss recommendation', () async {
        ...
        if (recommendations.isNotEmpty) {
          ...
          final dismissedRec =
              service.getRecommendation(recommendations.first.id);
    ...
    group('Performance', () {
      test('should generate recommendations efficiently for large requests',
          () async {
        // Arrange

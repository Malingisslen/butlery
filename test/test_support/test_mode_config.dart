...
mixin TestModeMixin {
  ...
  dynamic getArrayUnion(List<dynamic> elements) =>
      TestModeConfig.arrayUnion(elements);

  /// Get array remove based on test mode
  dynamic getArrayRemove(List<dynamic> elements) =>
      TestModeConfig.arrayRemove(elements);

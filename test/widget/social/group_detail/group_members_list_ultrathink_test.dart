  ...
  group('GroupMembersList Ultrathink Tests', () {
    ...
    List<GroupInvitation> createMockInvitations({
      ...
      for (int i = 0; i < count; i++) {
        invitations.add(GroupInvitation.create(
          ...
          toUserId: 'invitee_$i',
          personalMessage: includeSwedishNames ? 'Vill du vara med i gruppen?' : 'Join our group!',
        ));
      }
      return invitations;
    }
    ...
    group('Production Code Analysis', () {
      testWidgets('build method renders without crashes', (WidgetTester tester) async {
        ...
        expect(find.byType(Column), findsWidgets); // Main Column + nested columns from cards
        expect(find.byType(Row), findsWidgets); // Header row + member cards
      });

      testWidgets('displays Swedish header text correctly', (WidgetTester tester) async {
    ...
    group('Permission Logic Tests', () {
      testWidgets('shows add button when user can add members', (WidgetTester tester) async {
      ...
      testWidgets('shows add button by default (permission service behavior)', (WidgetTester tester) async {
      ...
      testWidgets('calls onAddMembers callback when add button pressed', (WidgetTester tester) async {
    ...
    group('Members Section Tests', () {
      testWidgets('displays members section with correct count', (WidgetTester tester) async {
      ...
      testWidgets('hides members section when no members', (WidgetTester tester) async {
      ...
      testWidgets('delegates to GroupMemberCard correctly', (WidgetTester tester) async {
      ...
      testWidgets('handles ListView separator correctly', (WidgetTester tester) async {
    ...
    group('Invitations Section Tests', () {
      testWidgets('displays invitations section with correct count', (WidgetTester tester) async {
      ...
      testWidgets('hides invitations section when no invitations', (WidgetTester tester) async {
      ...
      testWidgets('delegates to GroupInvitationCard correctly', (WidgetTester tester) async {
      ...
      testWidgets('adds spacing between members and invitations sections', (WidgetTester tester) async {
    ...
    group('Empty State Tests', () {
      testWidgets('shows empty state when no members or invitations', (WidgetTester tester) async {
        ...
        expect(find.text('Lägg till vänner i den här gruppen för att komma igång.'), findsOneWidget);
        expect(find.byIcon(Icons.people_outline), findsOneWidget);
      });

      testWidgets('hides empty state when members exist', (WidgetTester tester) async {
      ...
      testWidgets('hides empty state when invitations exist', (WidgetTester tester) async {
        // ULTRATHINK: Test conditional empty state
        final invitations = createMockInvitations(count: 1);
        final group = createMockGroup();
    ...
    group('Theme Integration Tests', () {
      ...
      testWidgets('uses AppDimensions constants correctly', (WidgetTester tester) async {
      ...
      testWidgets('applies color scheme correctly', (WidgetTester tester) async {
    ...
    group('Edge Cases and Error Handling', () {
      testWidgets('handles large member lists gracefully', (WidgetTester tester) async {
      ...
      testWidgets('handles rapid callback invocations', (WidgetTester tester) async {
      ...
      testWidgets('maintains layout with complex nested structures', (WidgetTester tester) async {
        ...
        expect(find.byType(Column), findsWidgets); // Main column + nested columns
        expect(find.byType(Row), findsWidgets); // Header row + card rows  
        expect(find.byType(ListView), findsWidgets); // Members and/or invitations lists
        expect(find.byType(Card), findsWidgets); // Member/invitation cards
      });
    });

    group('Service Integration Tests', () {
      testWidgets('integrates with PermissionService correctly', (WidgetTester tester) async {
      ...
      testWidgets('handles ServiceLocator access correctly', (WidgetTester tester) async {
    ...
    group('Model Integration Tests', () {
      testWidgets('handles complex UserProfile objects', (WidgetTester tester) async {
      ...
      testWidgets('handles complex GroupInvitation objects', (WidgetTester tester) async {
        ...
        final complexInvitations = [
          GroupInvitation.create(
            ...
            toUserId: 'user2',
            personalMessage: 'Hej! Vill du vara med i vår matlagningsgrupp? Vi lagar svenska rätter tillsammans!',
          ),
        ];
        final group = createMockGroup();
      ...
      testWidgets('handles complex FriendCategory objects', (WidgetTester tester) async {

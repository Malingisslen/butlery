...
void main() {
  group('GroupMemberCard Ultrathink Tests', () {
    ...
    setUp(() async {
      ...
      mockPermissionService = ServiceLocator.get<PermissionService>() as MockPermissionService;
    });
    ...
    group('Production Code Analysis', () {
      testWidgets('renders without crashes with minimal setup', (WidgetTester tester) async {
    ...
    group('Role Indicators Tests', () {
      testWidgets('displays owner badge when member is group owner', (WidgetTester tester) async {
      ...
      testWidgets('displays creator badge when member is group creator', (WidgetTester tester) async {
      ...
      testWidgets('displays both badges when member is both owner and creator', (WidgetTester tester) async {
      ...
      testWidgets('displays no badges for regular member', (WidgetTester tester) async {
    ...
    group('Permission Logic Tests', () {
      testWidgets('shows remove menu when user can remove member', (WidgetTester tester) async {
      ...
      testWidgets('hides remove menu when member is current user', (WidgetTester tester) async {
      ...
      testWidgets('hides remove menu when member is group owner', (WidgetTester tester) async {
      ...
      testWidgets('hides remove menu when user lacks permission', (WidgetTester tester) async {
    ...
    group('Swedish Localization Tests', () {
      testWidgets('displays Swedish text correctly', (WidgetTester tester) async {
      ...
      testWidgets('handles Swedish characters in member names', (WidgetTester tester) async {
    ...
    group('Edge Cases and Error Handling', () {
      testWidgets('handles null member properties gracefully', (WidgetTester tester) async {
        // ULTRATHINK: Test edge cases with minimal data
        final member = UserBuilder()
          .withId('minimal_member')
          .withName('')
          .build();
        final group = createMockGroup();
      ...
      testWidgets('handles very long member names with ellipsis', (WidgetTester tester) async {
        // ULTRATHINK: Test overflow handling for long names
        final member = UserBuilder()
          .withId('long_name_member')
          .withName('This is an extremely long member name that should be truncated with ellipsis in the UI to prevent overflow')
          .build();
        final group = createMockGroup();
      ...
      testWidgets('handles onRemoved callback correctly', (WidgetTester tester) async {
    ...
    group('SocialComponents Integration Tests', () {
      testWidgets('delegates avatar rendering to SocialComponents', (WidgetTester tester) async {

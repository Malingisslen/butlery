...
void main() {
  group('RecipeImageWidget Ultrathink Tests', () {
    ...
    group('Factory Constructor Tests', () {
      testWidgets(
          'RecipeImageWidget.card factory creates correct configuration',
          (WidgetTester tester) async {
        ...
        final widget =
            tester.widget<RecipeImageWidget>(find.byType(RecipeImageWidget));
        expect(widget.config.type, equals(ImageType.recipeCard));
      });

      testWidgets(
          'RecipeImageWidget.detail factory creates correct configuration',
          (WidgetTester tester) async {
    ...
    group('Recipe Detail Mode Tests', () {
      testWidgets(
          'displays recipe detail with navigation dots for multiple images',
          (WidgetTester tester) async {

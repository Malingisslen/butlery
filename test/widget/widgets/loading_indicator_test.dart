...
void main() {
  ...
  group('LoadingIndicator determinate variant (BUT-1173)', () {
    testWidgets('value != null renders a determinate CircularProgressIndicator',
        (tester) async {
    ...
    testWidgets(
      ...
      await pump(
        tester,
        const LoadingIndicator(value: null, backgroundColor: Color(0xFF112233)),
      );
  ...
  group('LoadingIndicator indeterminate (unchanged)', () {
    testWidgets('default (no value) uses the adaptive indeterminate indicator',
        (tester) async {

...
void main() {
  testWidgets('renders the duration phrase as a tappable chip', (tester) async {
    ...
    await tester.pumpWidget(_wrap(InlineTimerText(
  ...
  testWidgets('chip exposes a button semantics label for screen readers',
    ...
    expect(find.bySemanticsLabel(RegExp('Starta timer')), findsOneWidget,
        reason: 'Per ui-conventions, InkWell affordances need an explicit '

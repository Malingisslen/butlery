...
void main() {
  group('MainViewHeader — preferredSize', () {
    ...
    test('showAccentBar=false → headerHeight only', () {
      ...
      expect(
          h.preferredSize, const Size.fromHeight(MainViewHeader.headerHeight));
    });
  ...
  group('MainViewHeader — render', () {
    testWidgets('renders title lowercased', (tester) async {
      await tester
          .pumpWidget(_wrap(const MainViewHeader(title: 'DINA RECEPT')));
    ...
    testWidgets('renders count badge when supplied', (tester) async {
      await tester.pumpWidget(_wrap(const MainViewHeader(
        title: 'dina recept',
    ...
    testWidgets('renders trailing widget', (tester) async {
      await tester.pumpWidget(_wrap(MainViewHeader(
        title: 't',
        trailing: IconButton(
  ...
  group('ButleryFilterChips', () {
    testWidgets('renders all chip labels', (tester) async {
      await tester.pumpWidget(_wrap(ButleryFilterChips(
  ...
  group('ButlerySectionHeader', () {
    testWidgets('renders label lowercased', (tester) async {
      await tester.pumpWidget(_wrap(const ButlerySectionHeader(

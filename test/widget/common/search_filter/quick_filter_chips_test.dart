...
void main() {
  group('QuickFilterChips', () {
    ...
    group('Alla (All) Option Behavior', () {
      testWidgets(
          'should show Alla as selected when no filters are active',
          (tester) async {
        await tester.pumpWidget(
          createTestWidget(
            selectedIds: {},
      ...
      testWidgets(
          'should clear all filters when Alla is tapped',
          (tester) async {
      ...
      testWidgets(
          'should not trigger callback when Alla is already selected',
          (tester) async {
    ...
    group('Filter Toggle Behavior', () {
      testWidgets('should call onFilterToggle with correct id',
          (tester) async {
        String? toggledId;
      ...
      testWidgets('should call onFilterToggle for each filter',
          (tester) async {
        final toggledIds = <String>[];

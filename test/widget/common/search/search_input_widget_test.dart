...
void main() {
  group('SearchInputWidget', () {
    ...
    group('Trailing Widget (UI Redesign)', () {
      testWidgets('should render trailing widget when provided', (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
              body: SearchInputWidget(
      ...
      testWidgets('should show both clear button and trailing when text entered',
          (tester) async {
        controller.text = 'test';
      ...
      testWidgets('should show only trailing when text is empty', (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
              body: SearchInputWidget(

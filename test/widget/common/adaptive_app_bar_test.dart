...
void main() {
  ...
  testWidgets('preferredSize is the slimmer iOS bar height on iOS', (
    ...
    debugDefaultTargetPlatformOverride = TargetPlatform.android;
    expect(
      const AdaptiveAppBar(title: 'x').preferredSize.height,
      kToolbarHeight,
    );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        tester.widget<Text>(find.text('Branded')).style?.color,
  ...
  testWidgets(
    ...
    'so the back chevron / trailing controls are branded',
    (tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.iOS;
      addTearDown(() => debugDefaultTargetPlatformOverride = null);
  ...
  testWidgets(
    'a bottom forces a Material AppBar even on iOS, height included',
    (tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.iOS;
      addTearDown(() => debugDefaultTargetPlatformOverride = null);

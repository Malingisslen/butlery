...
void main() {
  group('TextDisplayCard Tests - ULTRATHINK METHODOLOGY', () {
    ...
    const String longText =
        'This is a very long text that might need scrolling behavior to be properly tested in various scenarios and edge cases';
    const String emptyText = '';
    const String swedishText =
        'Svensk text med åäö tecken för att testa lokalisering';

    group('Widget Construction and Required Parameters', () {
      testWidgets('should render with required text parameter',
    ...
    group('Optional Parameter Defaults and Overrides', () {
      testWidgets('should use default scrollable = true behavior',
          (WidgetTester tester) async {
      ...
      testWidgets('should allow scrollable override to false',
          (WidgetTester tester) async {
      ...
      testWidgets('should accept custom text style parameter',
          (WidgetTester tester) async {
      ...
      testWidgets('should accept custom background color parameter',
          (WidgetTester tester) async {
      ...
      testWidgets('should accept custom border color parameter',
          (WidgetTester tester) async {
      ...
      testWidgets('should accept custom padding parameter',
          (WidgetTester tester) async {
    ...
    group('Theme Integration and Fallbacks', () {
      testWidgets('should use theme text style when textStyle not provided',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'should use AppColors.backgroundTint when backgroundColor not provided',
          (WidgetTester tester) async {
      ...
      testWidgets('should use AppColors.divider when borderColor not provided',
          (WidgetTester tester) async {
      ...
      testWidgets('should use AppDimensions.paddingL when padding not provided',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'should use AppDimensions.borderRadiusM for container decoration',
          (WidgetTester tester) async {
    ...
    group('Container Decoration and Styling', () {
      testWidgets('should create proper container decoration structure',
          (WidgetTester tester) async {
      ...
      testWidgets('should support all decoration customizations together',
          (WidgetTester tester) async {
    ...
    group('Scrolling Behavior and Content Handling', () {
      testWidgets(
          'should wrap content in SingleChildScrollView when scrollable = true',
          (WidgetTester tester) async {
      ...
      testWidgets('should render text directly when scrollable = false',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle long text with scrolling enabled',
          (WidgetTester tester) async {
        ...
        await tester.drag(
            find.byType(SingleChildScrollView), const Offset(0, -20));
        await tester.pumpAndSettle();
      });

      testWidgets('should handle long text without scrolling when disabled',
          (WidgetTester tester) async {
    ...
    group('Edge Cases and Parameter Validation', () {
      ...
      testWidgets('should handle special characters and emojis',
          (WidgetTester tester) async {
        // ULTRATHINK: Test special character support
        const specialText =
            '🍕🥗🍰 Special chars: @#\$%^&*()_+{}|:"<>?[]\\;\',./ åäöÅÄÖ';
    ...
    group('Widget Integration and Context Requirements', () {
      testWidgets('should work within different parent widgets',
          (WidgetTester tester) async {
      ...
      testWidgets('should maintain performance with multiple instances',
          (WidgetTester tester) async {
            ...
            home: Scaffold(
              body: ListView(
                children: List.generate(
                    20, (index) => TextDisplayCard(text: 'Card $index')),
              ),
            ),
          ),
        );
    ...
    group('Build Method Behavior and Widget Tree Structure', () {
      ...
      testWidgets('should create alternate widget tree when scrollable = false',
          (WidgetTester tester) async {
      ...
      testWidgets('should build consistently across multiple rebuilds',
          (WidgetTester tester) async {
    ...
    group('Production Use Case Scenarios', () {
      testWidgets('should work for OCR results display scenario',
          (WidgetTester tester) async {
      ...
      testWidgets('should work for preview display scenario',
          (WidgetTester tester) async {
        // ULTRATHINK: Test preview use case mentioned in documentation (line 10)
        const previewText =
            'Recipe Preview: Delicious Swedish meatballs with lingonberry sauce';

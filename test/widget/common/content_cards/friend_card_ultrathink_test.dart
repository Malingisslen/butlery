...
void main() {
  ...
  group('FriendCard Ultrathink Widget Tests', () {
    ...
    group('FriendCard - Detailed Style Rendering', () {
      testWidgets('renders detailed style with all components - Swedish user',
      ...
      testWidgets('renders with online status indicator correctly',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: onlineUser,
      ...
      testWidgets('renders without online status when disabled',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: onlineUser,
      ...
      testWidgets('handles metadata display correctly',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
      ...
      testWidgets('displays custom subtitle correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('handles trailing widget correctly',
          (WidgetTester tester) async {
    ...
    group('FriendCard - Compact Style Rendering', () {
      testWidgets('renders compact style layout correctly',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
      ...
      testWidgets('uses smaller avatar in compact mode',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
      ...
      testWidgets('applies compact style padding correctly',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
    ...
    group('FriendCard - List Style Rendering', () {
      testWidgets('renders list style using ListTile',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
      ...
      testWidgets('shows subtitle in list style when provided',
          (WidgetTester tester) async {
      ...
      testWidgets('shows metadata as subtitle when no custom subtitle',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
    ...
    group('FriendCard - Interactive Behavior', () {
      testWidgets('handles tap callback correctly',
          (WidgetTester tester) async {
        bool tapped = false;
      ...
      testWidgets('handles long press callback correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('list style uses ListTile onTap when provided',
          (WidgetTester tester) async {
        bool tapped = false;
    ...
    group('FriendCard - Custom Styling', () {
      testWidgets('applies custom margin correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('uses default styling when not specified',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
        ...
        final defaultPaddedContainer = containers.firstWhere(
          (container) =>
              container.padding == const EdgeInsets.all(AppDimensions.spacingS),
        );
        expect(defaultPaddedContainer, isNotNull);
      });

      testWidgets('applies correct decoration with background and border',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
    ...
    group('FriendCard - Avatar System', () {
      testWidgets('renders avatar with correct size for detailed style',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
        ...
        expect(
            clipRRect.borderRadius, equals(BorderRadius.circular(25))); // 50/2
      });
      ...
      testWidgets('shows placeholder icon when no avatar URL',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
      ...
      testWidgets('status indicator scales with avatar size',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: onlineUser,
    ...
    group('FriendCard - Swedish Localization & Character Support', () {
      testWidgets('displays Swedish characters correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('handles Swedish compound names correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('displays member since text in Swedish',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
            user: swedishUser,
    ...
    group('FriendCard - Edge Cases & Error Handling', () {
      testWidgets('handles empty display name gracefully',
          (WidgetTester tester) async {
      ...
      testWidgets('handles very long names with ellipsis',
        ...
        final nameText =
            tester.widget<Text>(find.textContaining('Maria Elisabet'));
      ...
      testWidgets('handles null online status correctly',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendCard(
  ...
  group('FriendRequestCard Ultrathink Widget Tests', () {
    ...
    group('FriendRequestCard - Basic Rendering', () {
      testWidgets('renders friend request with basic content',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
      ...
      testWidgets('displays custom message when provided',
        ...
        final messageText =
            tester.widget<Text>(find.text('Hej! Vill vi bli vänner?'));
        expect(messageText.maxLines, equals(2));
        expect(messageText.overflow, equals(TextOverflow.ellipsis));
      });

      testWidgets('renders sender avatar placeholder correctly',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendRequestCard(
            friendRequest: testRequest,
    ...
    group('FriendRequestCard - Action Buttons', () {
      testWidgets('renders accept and decline buttons when callbacks provided',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendRequestCard(
            friendRequest: testRequest,
      ...
      testWidgets('handles accept button callback correctly',
          (WidgetTester tester) async {
        bool accepted = false;
      ...
      testWidgets('handles decline button callback correctly',
          (WidgetTester tester) async {
        bool declined = false;
      ...
      testWidgets('does not show action buttons when callbacks not provided',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendRequestCard(
            friendRequest: testRequest,
      ...
      testWidgets('applies correct button styling',
          (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(
          child: FriendRequestCard(
            friendRequest: testRequest,
        ...
        expect(outlinedButton.style?.side?.resolve({})?.color,
            equals(AppColors.textMedium));
    ...
    group('FriendRequestCard - Custom Styling', () {
      ...
      testWidgets('uses default styling when not specified',
        ...
        final outerContainer =
            tester.widget<Container>(find.byType(Container).first);
        expect(outerContainer.margin,
            equals(const EdgeInsets.only(bottom: AppDimensions.spacingS)));
    ...
    group('FriendRequestCard - Edge Cases', () {
      testWidgets('handles empty message correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('handles very long message with ellipsis',
          (WidgetTester tester) async {
        final longMessageRequest = FriendRequest(
          ...
          toUserId: 'user2',
          message:
              'Detta är ett mycket långt meddelande som borde trunkeras eftersom det tar upp för mycket utrymme på skärmen och inte passar in i layouten',
          sentAt: DateTime.now(),
          status: FriendRequestStatus.pending,
        );
        ...
        expect(find.textContaining('Detta är ett mycket långt meddelande'),
            findsOneWidget);

        // Should have maxLines and ellipsis
        final messageText = tester.widget<Text>(
            find.textContaining('Detta är ett mycket långt meddelande'));
        expect(messageText.maxLines, equals(2));
        expect(messageText.overflow, equals(TextOverflow.ellipsis));
      });
    });

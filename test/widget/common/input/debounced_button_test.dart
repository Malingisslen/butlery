...
void main() {
  group('DebouncedButton — render', () {
    ...
    testWidgets('semanticLabel wraps in an explicit Semantics with button=true',
        (tester) async {
      await tester.pumpWidget(_wrap(
        DebouncedButton(
          onPressed: () {},
  ...
  group('DebouncedButton — callback + debounce', () {
    ...
    testWidgets('rapid taps inside debounce window invoke onPressed only once',
        (tester) async {
      var taps = 0;
      await tester.pumpWidget(_wrap(
        DebouncedButton(
    ...
    testWidgets('async onPressed keeps button disabled until Future completes',
        (tester) async {

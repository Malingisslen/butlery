...
void main() {
  ...
  group('ButleryHeader — render', () {
    testWidgets('renders the title in lowercase', (tester) async {
      await tester.pumpWidget(_scaffoldWith(const ButleryHeader(
        title: 'MINA RECEPT',
      )));
    ...
    testWidgets('explicit leading widget wins over auto back button',
        (tester) async {
      await tester.pumpWidget(_scaffoldWith(ButleryHeader(
        title: 't',
        leading: IconButton(
  ...
  group('SliverButleryHeader', () {
    ...
    testWidgets('renders lowercase title in SliverAppBar', (tester) async {
      await tester.pumpWidget(sliverApp(const SliverButleryHeader(
        title: 'SLIVER TITLE',
      )));
      await tester.pump();
    ...
    testWidgets('accent bar shows by default as the SliverAppBar bottom',
      ...
      expect(bar.bottom!.preferredSize,
    ...
    testWidgets('trailing widget wired into SliverAppBar.actions',
        (tester) async {
      await tester.pumpWidget(sliverApp(SliverButleryHeader(
        title: 't',
        trailing: IconButton(
          icon: const Icon(Icons.search),
          onPressed: () {},

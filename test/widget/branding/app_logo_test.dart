  ...
  group('AppLogo Widget Tests', () {
    ...
    group('Default Constructor', () {
      ...
      testWidgets('should accept custom size', (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          createTestWidget(const AppLogo(size: customSize)),
        );
      ...
      testWidgets('should render shadow when showShadow is true', (
        ...
        expect(
          ...
          equals(AppShadows.elevated.length),
        );
    ...
    group('Named Constructors', () {
      ...
      testWidgets('AppLogo.small should render with small size', (
        ...
        expect(
          container.constraints?.maxWidth,
          equals(AppDimensions.iconSizeXxl),
        );
  ...
  group('AppBranding Widget Tests', () {
    ...
    group('Default Constructor', () {
      ...
      testWidgets('should render tagline when provided', (
        ...
        expect(
          ...
          equals(5),
        ); // Logo, spacing, name, spacing, tagline
      });
    ...
    group('Layout and Spacing', () {
      testWidgets('should have correct spacing between elements', (
        ...
        expect(
          (children[1] as SizedBox).height,
          equals(AppDimensions.spacingMd),
        );

        // Check spacing before tagline
        expect(children[3], isA<SizedBox>());
        expect(
          (children[3] as SizedBox).height,
          equals(AppDimensions.spacingSm),
        );
      });
    ...
    group('Theme Integration', () {
      testWidgets('should use theme colors for text', (
        ...
        await tester.pumpWidget(
          createTestWidget(const AppBranding(tagline: 'Test')),
        );
    ...
    group('Swedish Localization', () {
      testWidgets('auth variant should display Swedish tagline', (
        ...
        final tagline = tester.widget<Text>(
          find.text('Din personliga recept-assistent'),
        );

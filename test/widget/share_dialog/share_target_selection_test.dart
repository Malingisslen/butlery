...
void main() {
  group('ShareTargetSelection Widget Tests', () {
    ...
    testWidgets('renders share target selection using Builder for context', (WidgetTester tester) async {
    ...
    testWidgets('shows correct Swedish text for empty friends', (WidgetTester tester) async {
      final selectedIds = <String>{};
      String searchQuery = '';
    ...
    testWidgets('shows correct Swedish text for no search results', (WidgetTester tester) async {
      final selectedIds = <String>{};

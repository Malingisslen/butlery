  ...
  group('Ingredient Normalization Persistence', () {
    ...
    group('needsNormalization()', () {
      test('returns true when ingredientsNormalized is null', () {
        ...
        expect(
          IngredientProcessor.needsNormalization(recipe),
          true,
      ...
      test('returns false when both lists are empty', () {
        ...
        expect(
          IngredientProcessor.needsNormalization(recipeWithEmpty),
          false,
      ...
      test('returns true when lengths mismatch', () {
        ...
        expect(
          IngredientProcessor.needsNormalization(recipeWithMismatch),
          true,
      ...
      test('returns false when lengths match', () {
        ...
        expect(
          IngredientProcessor.needsNormalization(recipeWithMatching),
          false,
          reason: 'Matching lengths assumes already normalized (optimization)',
        );
      });
      ...
      test('returns true when content changed but count is same', () {
        ...
        expect(
          IngredientProcessor.needsNormalization(staleRecipe),
          true,
          reason:
    ...
    group('Recipe Model Integration', () {
      ...
      test('Recipe serialization includes ingredientsNormalized', () {
        ...
        expect(
          coreData.containsKey('ingredientsNormalized'),
          true,
      ...
      test('Recipe deserialization handles missing ingredientsNormalized', () {
        ...
        expect(
          recipeJson.core.ingredientsNormalized,
          isNull,
      ...
      test(
        'Recipe deserialization loads ingredientsNormalized when present',
        () {
    ...
    group('Complete Flow Simulation', () {
      test('simulates recipe creation with auto-population', () {
        ...
        expect(
          recipeToSave.core.ingredientsNormalized![0],
          contains('kött'),
          reason: 'Core meat ingredient',
        );
        expect(
          recipeToSave.core.ingredientsNormalized![1],
          'lök',
          reason: 'hackad should be removed',
        );
        expect(
          recipeToSave.core.ingredientsNormalized![2],
          contains('vitlök'),
          reason: 'Garlic ingredient (may vary)',
        );
        expect(recipeToSave.core.ingredientsNormalized![3], contains('tomat'));
        expect(
          recipeToSave.core.ingredientsNormalized![4],
          contains('tomat'),
          reason: 'Tomato-based products may vary in normalization',
        );
        expect(
          recipeToSave.core.ingredientsNormalized![5],
          contains('oregano'),
        );
        ...
        expect(
          recipeToSave.core.ingredients[1],
          '2 dl hackad lök',
      ...
      test('simulates recipe update refreshing normalized ingredients', () {
        ...
        expect(
          IngredientProcessor.needsNormalization(editedRecipe),
          true,
          reason: 'Length mismatch should trigger re-normalization',
        );
        ...
        expect(
          recipeToUpdate.core.ingredientsNormalized!.length,
          3,
          reason: 'Normalized list should now have 3 items',
        );
        expect(
          recipeToUpdate.core.ingredientsNormalized![2],
          'vetemjöl',
      ...
      test('simulates recipe with no changes skipping normalization', () {
        ...
        expect(
          IngredientProcessor.needsNormalization(updatedRecipe),
          false,
          reason: 'No normalization needed when lengths match (optimization)',
        );

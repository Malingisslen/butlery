  ...
  group('FirebaseShoppingRepository Integration Tests', () {
    ...
    group('Collaborative Shopping Lists', () {
      test('should create collaborative shopping list', () async {
        ...
        expect(created.memberPermissions[testUserId], equals(SharedListPermission.admin));
      ...
      test('should throw permission error when non-owner tries to delete', () async {
        // Arrange
        final list = UnifiedShoppingList.collaborative(
          name: 'Protected List',
          ownerId: 'other-user',
    ...
    group('Template Operations', () {
      ...
      test('should save public template', () async {
        ...
        expect(doc.data()!['createdByDisplayName'], equals(testUserDisplayName));
      });
      ...
      test('should get user templates', () async {
        ...
        final list = await repository.create(
          UnifiedShoppingList.personal(
            ...
            ownerDisplayName: testUserDisplayName,
            items: [
              UnifiedShoppingItem.basic(name: 'Item 1', amount: 1, unit: 'st', category: 'Cat1'),
              UnifiedShoppingItem.basic(name: 'Item 2', amount: 2, unit: 'st', category: 'Cat2'),
            ],
          ),
        );
      ...
      test('should get public templates with search', () async {
        ...
        // Assert
        expect(results.where((t) => t['isPublic'] == true).length, equals(results.length));
        expect(results.any((t) => t['name'].toString().toLowerCase().contains('weekly')), isTrue);
    ...
    group('Permission Validation', () {
      ...
      test('should validate member permissions for collaborative lists', () async {
        // Arrange
        final list = UnifiedShoppingList.collaborative(
    ...
    group('Archive Operations', () {
      test('should archive old completed lists', () async {
        ...
        await fakeFirestore
            ...
            .set({
              ...oldList.toFirestore(),
              'updatedAt': Timestamp.fromDate(oldDate),
            });

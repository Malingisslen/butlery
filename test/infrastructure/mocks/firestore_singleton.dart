...
class FirestoreSingleton {
  ...
  static const int _maxOperationsBeforeReset = 100; // Force reset after 100 operations
  ...
  static FakeFirebaseFirestore get instance {
    ...
    if (_operationCount > _maxOperationsBeforeReset) {
      debugPrint('Force resetting FakeFirebaseFirestore after $_operationCount operations');
      _forceRecreate();
    }
  ...
  static Future<void> clearData() async {
    ...
    try {
      ...
      if (_currentTestName != null && _testCollections[_currentTestName] != null) {
      ...
      if (totalDeleted > _maxDataSize) {
        ...
        debugPrint('Cleared $totalDeleted documents from FakeFirebaseFirestore');
      }
  ...
  static bool get shouldForceCleanup => 
      _operationCount > _maxOperationsBeforeReset || 
      _referenceCount < 0;
}
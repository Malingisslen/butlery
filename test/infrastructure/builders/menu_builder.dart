...
class MenuBuilder {
    ...
    _menuSnapshot = {
      'Middag': [
        RecipeBuilder()
            ...
            .withId('recipe_kottbullar')
            .build(),
        RecipeBuilder()
            .withTitle('Ärtsoppa med pannkakor')
            .withId('recipe_artsoppa')
            .build(),
        RecipeBuilder()
            .withTitle('Fredagstacos')
            .withId('recipe_tacos')
            .build(),
      ...
      'Lunch': [
        RecipeBuilder()
            ...
            .withId('recipe_raksmorgas')
            .build(),
        RecipeBuilder()
            .withTitle('Caesar sallad')
            .withId('recipe_caesar')
            .build(),
      ],
      'Fika': [
        RecipeBuilder()
            .withTitle('Kanelbullar')
            .withId('recipe_kanelbullar')
            .build(),
        RecipeBuilder()
            .withTitle('Kladdkaka')
            .withId('recipe_kladdkaka')
            .build(),
      ],
    };
  ...
  MenuBuilder asHolidayMenu() {
    ...
    _menuSnapshot = {
      'Huvudrätter': [
        RecipeBuilder()
            .withTitle('Julskinka')
            .withId('recipe_julskinka')
            .build(),
        RecipeBuilder()
            .withTitle('Janssons frestelse')
            .withId('recipe_janssons')
            .build(),
        RecipeBuilder()
            .withTitle('Köttbullar')
            .withId('recipe_jul_kottbullar')
            .build(),
      ],
      'Sill och fisk': [
      ...
      'Desserter': [
        RecipeBuilder()
            .withTitle('Pepparkakor')
            .withId('recipe_pepparkakor')
            .build(),
        RecipeBuilder()
            .withTitle('Saffransbullar')
            .withId('recipe_saffran')
            .build(),
      ],
    };
  ...
  MenuBuilder asBreakfastMenu() {
    ...
    _menuSnapshot = {
      'Frukost': [
        RecipeBuilder()
            .withTitle('Havregrynsgröt')
            .withId('recipe_grot')
            .build(),
        RecipeBuilder()
            .withTitle('Filmjölk med müsli')
            .withId('recipe_filmjolk')
            .build(),
        RecipeBuilder().withTitle('Äggmacka').withId('recipe_aggmacka').build(),
        RecipeBuilder()
            .withTitle('Yoghurt med granola')
            .withId('recipe_yoghurt')
            .build(),
        RecipeBuilder()
            .withTitle('Smoothie bowl')
            .withId('recipe_smoothie')
            .build(),
        RecipeBuilder()
            .withTitle('Pannkakor')
            .withId('recipe_pannkakor')
            .build(),
        RecipeBuilder()
            .withTitle('Äggröra med bacon')
            .withId('recipe_aggrora')
            .build(),
      ],
    };

...
class RecipeCommentBuilder {
  ...
  RecipeCommentBuilder asPositiveReview() {
    _text = 'This recipe turned out amazing! The instructions were clear and easy to follow.';
  ...
  RecipeCommentBuilder asPopular() {
    ...
    _replyCount = 15;
    _text = 'Pro tip: Let the dough rest for an extra 30 minutes for better texture!';
    return this;
  }

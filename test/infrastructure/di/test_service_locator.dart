...
class TestServiceLocator {
  ...
  static Future<void> _initializeProductionServiceLocator() async {
    try {
      ...
      // Initialize production ServiceLocator with our MockDIContainer
      // The MockDIContainer will delegate back to TestServiceLocator
      ...
      debugPrint('Production ServiceLocator initialization: $e');
    }
  }

...
- A source edit made THROUGH another language inherits ITS escape rules: `\b` in a Python heredoc writes a literal BACKSPACE into a Dart comment — compiler-invisible, and it recurred 5x, each time in a CORRECTION. Use `chr(92)+'b'`; sweep `grep -rlP '[\x00-\x08]'` (2026-08-19).

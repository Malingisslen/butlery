---
name: "source-command-drift-migration"
...
# source-command-drift-migration

Use this skill when the user asks to run the migrated source command `drift-migration`.
...
Schema migrations are intentional acts. Codex can compose them, but the

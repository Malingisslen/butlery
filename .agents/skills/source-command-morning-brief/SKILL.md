---
name: "source-command-morning-brief"
...
# source-command-morning-brief

Use this skill when the user asks to run the migrated source command `morning-brief`.
...
— the reason the old `setup` mode never worked). The standing trigger is a **Codex.ai

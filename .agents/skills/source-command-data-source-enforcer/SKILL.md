---
name: "source-command-data-source-enforcer"
description: "CRITICAL: Prevents mixing UserService and PermissionService data sources. Use when accessing user data, settings, avatars, authentication state, or debugging 'settings not persisting' issues. UserService for profile data, PermissionService for auth checks only."
---

# source-command-data-source-enforcer

Use this skill when the user asks to run the migrated source command `data-source-enforcer`.

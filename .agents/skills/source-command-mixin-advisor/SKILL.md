---
name: "source-command-mixin-advisor"
description: "Recommends correct mixin combinations for services, repositories, and viewmodels. Use when creating new services/repositories/viewmodels or when a service is missing ErrorHandlingMixin or StreamManagementMixin."
---

# source-command-mixin-advisor

Use this skill when the user asks to run the migrated source command `mixin-advisor`.

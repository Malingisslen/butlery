---
name: "source-command-permission-test-generator"
description: "Generates standard permission validation tests for Firebase repositories. Use when creating tests for any repository, adding CRUD operations, or verifying permission checks (create/read/update/delete for own vs other user)."
---

# source-command-permission-test-generator

Use this skill when the user asks to run the migrated source command `permission-test-generator`.

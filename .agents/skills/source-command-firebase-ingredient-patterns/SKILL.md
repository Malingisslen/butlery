---
name: "source-command-firebase-ingredient-patterns"
description: "Firebase ingredient data patterns, lookup pipeline, and tagging integration. Use when modifying ingredient lookup logic, adding tagging properties, working with user-defined ingredients, debugging ingredient search, or implementing ingredient UI."
---

# source-command-firebase-ingredient-patterns

Use this skill when the user asks to run the migrated source command `firebase-ingredient-patterns`.

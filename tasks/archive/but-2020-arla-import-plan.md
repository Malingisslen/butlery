...
`ArlaRecipeParser.parseRecipe` returnerar `null` för varje riktig arla.se-sida. Mätt
2026-09-05 mot en sida hämtad samma dag, pinnat av fem `DEFECT:`-fall i
`test/unit/services/extraction/site_parsers/real_structure_test.dart` (13/13 gröna).

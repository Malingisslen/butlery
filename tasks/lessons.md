...
### En granskares VERDIKTRAD registreras bara om inget står efter den (2026-09-20)
Date: 2026-09-20
...
Rule: Skriv i varje granskarbrief att verdiktraden ska vara meddelandets SISTA rad, ensam, utan text efter — och verifiera efteråt med `grep '"t":"verdict"' .claude/state/review-ledger.jsonl | tail`, aldrig genom att läsa granskarens rapport. En rapport som SÄGER "pass" och en liggare som registrerat "pass" är två olika saker, och det är bara den andra grinden läser. Väck samma körning i stället för att starta en ny granskning: läsningarna står kvar, och en ny körning betalar hela omläsningen igen.
Example: 2026-09-20 — 097526861 och 9a1216413. Båda commiterna stoppades en gång var på en saknad verdiktrad, från granskare som redan passerat.

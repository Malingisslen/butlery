...
1. ErrorHandlingMixin / BaseService
2. AsyncOperationMixin (for ViewModels)
3. BaseFirebaseRepository
4. SerializationUtils
5. ValidationUtils
6. Default Value Extensions (.orEmpty(), .hasItems, etc.)
7. Test Helpers (RepositoryTestBase, ServiceTestBase)

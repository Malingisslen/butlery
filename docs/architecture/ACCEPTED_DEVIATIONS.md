...
- **Burst guards are stamped in the same request, and messages carry none (ADR-0020,
  ...
  **Malin's explicit calls, 2026-09-14:** this mechanism over a Cloud Function; no burst guard on
  ...
  Retired verbatim, from the BUT-1838 roster-cap section: "`rateLimitWrite('conversations', 10)` does NOT cap the rate: it reads"
...
- **ASKED AND ANSWERED 2026-09-18 (BUT-2006, question 1) — `contributorUserIds` on the group
  ...
  Retired verbatim (2026-09-17 section): `` **Still open, and NOT answered by row 2:** BUT-2006 question 1 — whether `contributorUserIds` should union PASSIVE participants at all. ``

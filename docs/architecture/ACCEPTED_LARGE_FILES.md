...
| `message_mutation_module.dart` | 579 | Focused module for atomic message send, plus the BUT-1832 poll-vote write pair (`votePoll` transaction + `closePoll`). Row refreshed 2026-08-17 (was recorded at 557 for the send path alone). |

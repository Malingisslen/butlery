...
| Managed backups on disk | 8 READY on 2026-09-17 — seven daily snapshots 2026-09-10 through 2026-09-16, plus the first WEEKLY snapshot, 2026-09-13T10:57:26Z, expiring 2026-12-20 | Read with the Firebase MCP's `firestore_list_backups` on `projects/butlery-app-1/locations/-`, **not** the gcloud command in the row above — same Admin API, and the `-` location avoids the `eur3` trap. Two backups share `snapshotTime` 2026-09-13T10:57:26Z: one expiring 2026-09-20 (the daily) and one 2026-12-20 (the weekly). BUT-2098 |

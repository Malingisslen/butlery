...
| ARCH-004 | 218 services (85.2% of services) | Not extending BaseService - missing error handling, lifecycle, logging | High | XL | P1 | Open | Systematic migration to BaseService (4-6 weeks, 10 services/week) |
| ARCH-005 | 97 ViewModels (98.0% of ViewModels) | Not using AsyncOperationMixin - manual state management duplication | High | L | P1 | Open | Systematic AsyncOperationMixin adoption (3-4 weeks, 15-20 ViewModels/week) |
...
| ARCH-008 | Infrastructure adoption | BaseFirebaseRepository claimed 90%+, actual 31.6% - documentation discrepancy | Medium | XS | P2 | Open | Update CLAUDE.md with actual adoption rates |
| ARCH-009 | Codebase-wide | SerializationUtils adoption 20 usages - duplicate Firestore parsing (600-800 lines waste) | Medium | M | P2 | Open | Adopt in all model fromFirestore methods (2 weeks) |
| ARCH-010 | Codebase-wide | ValidationUtils adoption 71 usages - duplicate validation (1,600-2,400 lines waste) | Medium | L | P2 | Open | Systematic adoption in forms and services (3-4 weeks) |
| ARCH-011 | Codebase-wide | Default Value Extensions adoption 7 usages - verbose null coalescing (400+ lines waste) | Low | S | P3 | Open | Replace ?? operators with extension methods (1 week) |
| ARCH-012 | Overall codebase | 5,400-7,900 lines of duplicate code due to low infrastructure adoption | High | XL | P1 | Open | Comprehensive infrastructure adoption program (15-22 weeks) |

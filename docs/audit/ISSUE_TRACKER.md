...
| ARCH-011 | Codebase-wide (400-800 locations) | Default Value Extensions adoption ~19-24% (Phase 1+2: 201 migrations across 17 files) - verbose null coalescing eliminated in models & ViewModels | Low | S | P3 | ✅ PHASE 2 COMPLETE | **Nov 2025 - Phase 2 Complete**: **Phase 1** (10 models, 129 migrations, ~120-150 lines): recipe_unified, shared_shopping_list, activity_feed_item, unified_shopping_list, shared_menu, shared_content, unified_shopping_item, recipe_serialization, user_profile, realtime_invitation. **Phase 2** (7 ViewModels, 72 migrations, ~70-85 lines): recipe_auto_save_manager (16), group_content_viewmodel (15), realtime_recipe_viewmodel (11), recipe_form_state (10), recipe_query_viewmodel (9), menu_storage (6), unified_shopping_viewmodel (5). **Total Impact**: 201 migrations, ~190-235 lines improved, 93.5% of Phase 2 target achieved. **Extension methods**: .orEmpty() (31×), .orFalse() (15×), .orZero() (17×), .orNow() (2×), .orDefault() (7×). **Learning**: ValidationUtils conflicts with extensions; keep ?? where ValidationUtils imported. **Phase 3 Target**: Services/Repositories (100-150 migrations, 2-3 weeks). |
